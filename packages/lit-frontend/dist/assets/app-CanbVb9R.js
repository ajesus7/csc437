 ...
 */function Mr({context:r,subscribe:e}){return(t,s)=>{typeof s=="object"?s.addInitializer(function(){new cr(this,{context:r,callback:o=>{this[s.name]=o},subscribe:e})}):t.constructor.addInitializer(o=>{new cr(o,{context:r,callback:a=>{o[s]=a},subscribe:e})})}}let Ki=class extends S{constructor(e,t){super(),this.model=t,this.updateFn=e,this.addEventListener("mvu:message",s=>{const o=s.detail;console.log("Got message: ",o),this.receive(o)})}receive(e){if(this.model){const t=this.updateFn(this.model,e),s=t;typeof(s==null?void 0:s.then)=="function"?s.then(o=>{const a=o(this.model);this.model=a}):this.model=t}}},Yi=class extends S{dispatchMessage(e,t=this){const s=new CustomEvent("mvu:message",{bubbles:!0,composed:!0,detail:e});t.dispatchEvent(s)}};class Qi{constructor(){this._handlers=new Map,this.update=this._update.bind(this)}addMessage(e,t){console.log("Message added for dispatch:",e),this._handlers.set(e,t)}_update(e,t){const{type:s}=t,o=this._handlers.get(s);return o?o(t,e):e}}function Xi(r){return e=>Object.assign({},e,r)}function Zi(r){return r}const en="http://localhost:3000",tn=`${en}`,rn="/api",St="JWT_AUTH_TOKEN",Y=class Y{constructor(){this.authenticated=!1,this.username="music_listener",this.signOut=()=>{}}static deauthenticate(e){const t=new Y;return console.log("Deauthenticating",e,Y._theUser),e===Y._theUser&&(localStorage.removeItem(St),Y._theUser=t),t}};Y._theUser=new Y;let j=Y;class Re extends j{constructor(e,t){super();const o=e.split(".")[1].replace(/-/g,"+").replace(/_/g,"/"),a=decodeURIComponent(window.atob(o).split("").map(function(u){return"%"+("00"+u.charCodeAt(0).toString(16)).slice(-2)}).join("")),l=JSON.parse(a);console.log("Token payload",l),this.token=e,this.authenticated=!0,this.username=l.username,this.signOut=t}static authenticate(e,t){return j._theUser=new Re(e,t),localStorage.setItem(St,e),j._theUser}static authenticateFromLocalStorage(e){const t=localStorage.getItem(St);return t?Re.authenticate(t,e):j._theUser}}class Ut{constructor(e){this._base=rn,this.json=e}base(e=""){return this._base=e,this}get(e){return fetch(this._url(e),{headers:this._headers(),body:this.json&&JSON.stringify(this.json)})}post(e){return fetch(this._url(e),{method:"POST",headers:this._headers(),body:this.json&&JSON.stringify(this.json)})}put(e){return fetch(this._url(e),{method:"PUT",headers:this._headers(),body:this.json&&JSON.stringify(this.json)})}_headers(){const e=this.json!==void 0,t=j._theUser.authenticated,s={"Content-Type":"application/json"};if(t){const a={Authorization:`Bearer ${j._theUser.token}`};return e?{...s,...a}:a}else return e?{...s}:void 0}_url(e){return`${tn}${this._base}${e}`}}class hr extends Ut{constructor(e){super(Object.fromEntries(e))}}class Dr extends Ut{constructor(){super(void 0)}}var nn=Object.defineProperty,sn=Object.getOwnPropertyDescriptor,Lr=(r,e,t,s)=>{for(var o=s>1?void 0:s?sn(e,t):e,a=r.length-1,l;a>=0;a--)(l=r[a])&&(o=(s?l(e,t,o):l(o))||o);return s&&o&&nn(e,t,o),o};const jr="MTVModel",ur={user:new j},on=()=>new Qi,Nr=Xi,zr=Zi;class Hr extends Ki{constructor(e){super(e,ur),this.model=ur}}Lr([Fr({context:jr}),B()],Hr.prototype,"model",2);class kt extends Yi{getFromModel(e){if(this._model)return this._model[e]}}Lr([Mr({context:jr,subscribe:!0}),x({attribute:!1})],kt.prototype,"_model",2);const Rt=on(),an=Rt.update;Rt.addMessage("ProfileSelected",r=>{const{userid:e}=r;return new Dr().get(`/profiles/${e}`).then(t=>{if(t.status===200)return t.json()}).then(t=>{if(t)return console.log("Profile:",t),t}).then(t=>t?Nr({profile:t}):zr)});Rt.addMessage("ProfileSaved",r=>{const{userid:e,profile:t}=r;return new Ut(t).put(`/profiles/${e}`).then(s=>{if(s.status===200)return s.json()}).then(s=>{s&&console.log("Profile:",s)}).then(s=>s?Nr({profile:s}):zr)});var cn=Object.defineProperty,ln=Object.getOwnPropertyDescriptor,Ne=(r,e,t,s)=>{for(var o=s>1?void 0:s?ln(e,t):e,a=r.length-1,l;a>=0;a--)(l=r[a])&&(o=(s?l(e,t,o):l(o))||o);return s&&o&&cn(e,t,o),o};let ne=class extends S{constructor(){super(),this.names=[],this.namesOriginalOrder=[],this.listAttributes=[],this.sort_state="unsorted",this.initializedNamesOriginalOrder=!1,this.names=[],this.namesOriginalOrder=[...this.names],this.listAttributes=[]}_onStateChanged(r){const e=r.target;this.initializedNamesOriginalOrder||(this.namesOriginalOrder=[...this.names],this.initializedNamesOriginalOrder=!0),this.sort_state=="unsorted"?this.names.sort((t,s)=>{const o=t[0].toUpperCase(),a=s[0].toUpperCase();return o<a?-1:o>a?1:0}):this.sort_state=="sorted"&&(this.names=[...this.namesOriginalOrder]),this.sort_state=e.filteredState}render(){return v`
  ...
  `;le([B()],G.prototype,"loginStatus",2);le([B()],G.prototype,"registerStatus",2);le([Fr({context:ni}),B()],G.prototype,"user",2);le([B()],G.prototype,"showLoginForm",2);le([B()],G.prototype,"showSignUpErrorMessage",2);le([B()],G.prototype,"showSignUpSuccessMessage",2);G=le([T("auth-required")],G);var ds=Object.defineProperty,ps=Object.getOwnPropertyDescriptor,Lt=(r,e,t,s)=>{for(var o=s>1?void 0:s?ps(e,t):e,a=r.length-1,l;a>=0;a--)(l=r[a])&&(o=(s?l(e,t,o):l(o))||o);return s&&o&&ds(e,t,o),o};let Le=class extends S{constructor(){super(...arguments),this.user=new j}render(){const{profileImage:r,profileDescription:e,userid:t}=this.profile||{};return v`
