...
`;function Ct(r){return r=r||[],Array.isArray(r)?r:[r]}function H(r){return`[Vaadin.Router] ${r}`}function Yn(r){if(typeof r!="object")return String(r);const e=Object.prototype.toString.call(r).match(/ (.*)\]$/)[1];return e==="Object"||e==="Array"?`${e} ${JSON.stringify(r)}`:e}const Pt="module",Ot="nomodule",sr=[Pt,Ot];function is(r){if(!r.match(/.+\.[m]?js$/))throw new Error(H(`Unsupported type for bundle "${r}": .js or .mjs expected.`))}function Ks(r){if(!r||!q(r.path))throw new Error(H('Expected route config to be an object with a "path" string property, or an array of such objects'));const e=r.bundle,t=["component","redirect","bundle"];if(!me(r.action)&&!Array.isArray(r.children)&&!me(r.children)&&!Rt(e)&&!t.some(s=>q(r[s])))throw new Error(H(`Expected route config "${r.path}" to include either "${t.join('", "')}" or "action" function but none found.`));if(e)if(q(e))is(e);else if(sr.some(s=>s in e))sr.forEach(s=>s in e&&is(e[s]));else throw new Error(H('Expected route bundle to include either "'+Ot+'" or "'+Pt+'" keys, or both'));r.redirect&&["bundle","component"].forEach(s=>{s in r&&console.warn(H(`Route config "${r.path}" has both "redirect" and "${s}" properties, and "redirect" will always override the latter. Did you mean to only use "${s}"?`))})}function ns(r){Ct(r).forEach(e=>Ks(e))}function os(r,e){let t=document.head.querySelector('script[src="'+r+'"][async]');return t||(t=document.createElement("script"),t.setAttribute("src",r),e===Pt?t.setAttribute("type",Pt):e===Ot&&t.setAttribute(Ot,""),t.async=!0),new Promise((s,i)=>{t.onreadystatechange=t.onload=a=>{t.__dynamicImportLoaded=!0,s(a)},t.onerror=a=>{t.parentNode&&t.parentNode.removeChild(t),i(a)},t.parentNode===null?document.head.appendChild(t):t.__dynamicImportLoaded&&s()})}function Jn(r){return q(r)?os(r):Promise.race(sr.filter(e=>e in r).map(e=>os(r[e],e)))}function We(r,e){return!window.dispatchEvent(new CustomEvent(`vaadin-router-${r}`,{cancelable:r==="go",detail:e}))}function Rt(r){return typeof r=="object"&&!!r}function me(r){return typeof r=="function"}function q(r){return typeof r=="string"}function Ys(r){const e=new Error(H(`Page not found (${r.pathname})`));return e.context=r,e.code=404,e}const Ce=new class{};function Gn(r){const e=r.port,t=r.protocol,a=t==="http:"&&e==="80"||t==="https:"&&e==="443"?r.hostname:r.host;return`${t}//${a}`}function as(r){if(r.defaultPrevented||r.button!==0||r.shiftKey||r.ctrlKey||r.altKey||r.metaKey)return;let e=r.target;const t=r.composedPath?r.composedPath():r.path||[];for(let h=0;h<t.length;h++){const p=t[h];if(p.nodeName&&p.nodeName.toLowerCase()==="a"){e=p;break}}for(;e&&e.nodeName.toLowerCase()!=="a";)e=e.parentNode;if(!e||e.nodeName.toLowerCase()!=="a"||e.target&&e.target.toLowerCase()!=="_self"||e.hasAttribute("download")||e.hasAttribute("router-ignore")||e.pathname===window.location.pathname&&e.hash!==""||(e.origin||Gn(e))!==window.location.origin)return;const{pathname:i,search:a,hash:c}=e;We("go",{pathname:i,search:a,hash:c})&&(r.preventDefault(),r&&r.type==="click"&&window.scrollTo(0,0))}const Xn={activate(){window.document.addEventListener("click",as)},inactivate(){window.document.removeEventListener("click",as)}},Qn=/Trident/.test(navigator.userAgent);Qn&&!me(window.PopStateEvent)&&(window.PopStateEvent=function(r,e){e=e||{};var t=document.createEvent("Event");return t.initEvent(r,!!e.bubbles,!!e.cancelable),t.state=e.state||null,t},window.PopStateEvent.prototype=window.Event.prototype);function cs(r){if(r.state==="vaadin-router-ignore")return;const{pathname:e,search:t,hash:s}=window.location;We("go",{pathname:e,search:t,hash:s})}const Zn={activate(){window.addEventListener("popstate",cs)},inactivate(){window.removeEventListener("popstate",cs)}};var Le=ei,eo=wr,to=no,ro=Xs,so=Zs,Js="/",Gs="./",io=new RegExp(["(\\\\.)","(?:\\:(\\w+)(?:\\(((?:\\\\.|[^\\\\()])+)\\))?|\\(((?:\\\\.|[^\\\\()])+)\\))([+*?])?"].join("|"),"g");function wr(r,e){for(var t=[],s=0,i=0,a="",c=e&&e.delimiter||Js,h=e&&e.delimiters||Gs,p=!1,m;(m=io.exec(r))!==null;){var y=m[0],b=m[1],w=m.index;if(a+=r.slice(i,w),i=w+y.length,b){a+=b[1],p=!0;continue}var x="",D=r[i],he=m[2],zt=m[3],Fe=m[4],xe=m[5];if(!p&&a.length){var Ee=a.length-1;h.indexOf(a[Ee])>-1&&(x=a[Ee],a=a.slice(0,Ee))}a&&(t.push(a),a="",p=!1);var Ht=x!==""&&D!==void 0&&D!==x,Z=xe==="+"||xe==="*",ut=xe==="?"||xe==="*",Ne=x||c,pt=zt||Fe;t.push({name:he||s++,prefix:x,delimiter:Ne,optional:ut,repeat:Z,partial:Ht,pattern:pt?oo(pt):"[^"+ne(Ne)+"]+?"})}return(a||i<r.length)&&t.push(a+r.substr(i)),t}function no(r,e){return Xs(wr(r,e))}function Xs(r){for(var e=new Array(r.length),t=0;t<r.length;t++)typeof r[t]=="object"&&(e[t]=new RegExp("^(?:"+r[t].pattern+")$"));return function(s,i){for(var a="",c=i&&i.encode||encodeURIComponent,h=0;h<r.length;h++){var p=r[h];if(typeof p=="string"){a+=p;continue}var m=s?s[p.name]:void 0,y;if(Array.isArray(m)){if(!p.repeat)throw new TypeError('Expected "'+p.name+'" to not repeat, but got array');if(m.length===0){if(p.optional)continue;throw new TypeError('Expected "'+p.name+'" to not be empty')}for(var b=0;b<m.length;b++){if(y=c(m[b],p),!e[h].test(y))throw new TypeError('Expected all "'+p.name+'" to match "'+p.pattern+'"');a+=(b===0?p.prefix:p.delimiter)+y}continue}if(typeof m=="string"||typeof m=="number"||typeof m=="boolean"){if(y=c(String(m),p),!e[h].test(y))throw new TypeError('Expected "'+p.name+'" to match "'+p.pattern+'", but got "'+y+'"');a+=p.prefix+y;continue}if(p.optional){p.partial&&(a+=p.prefix);continue}throw new TypeError('Expected "'+p.name+'" to be '+(p.repeat?"an array":"a string"))}return a}}function ne(r){return r.replace(/([.+*?=^!:${}()[\]|/\\])/g,"\\$1")}function oo(r){return r.replace(/([=!:$/()])/g,"\\$1")}function Qs(r){return r&&r.sensitive?"":"i"}function ao(r,e){if(!e)return r;var t=r.source.match(/\((?!\?)/g);if(t)for(var s=0;s<t.length;s++)e.push({name:s,prefix:null,delimiter:null,optional:!1,repeat:!1,partial:!1,pattern:null});return r}function co(r,e,t){for(var s=[],i=0;i<r.length;i++)s.push(ei(r[i],e,t).source);return new RegExp("(?:"+s.join("|")+")",Qs(t))}function lo(r,e,t){return Zs(wr(r,t),e,t)}function Zs(r,e,t){t=t||{};for(var s=t.strict,i=t.start!==!1,a=t.end!==!1,c=ne(t.delimiter||Js),h=t.delimiters||Gs,p=[].concat(t.endsWith||[]).map(ne).concat("$").join("|"),m=i?"^":"",y=r.length===0,b=0;b<r.length;b++){var w=r[b];if(typeof w=="string")m+=ne(w),y=b===r.length-1&&h.indexOf(w[w.length-1])>-1;else{var x=w.repeat?"(?:"+w.pattern+")(?:"+ne(w.delimiter)+"(?:"+w.pattern+"))*":w.pattern;e&&e.push(w),w.optional?w.partial?m+=ne(w.prefix)+"("+x+")?":m+="(?:"+ne(w.prefix)+"("+x+"))?":m+=ne(w.prefix)+"("+x+")"}}return a?(s||(m+="(?:"+c+")?"),m+=p==="$"?"$":"(?="+p+")"):(s||(m+="(?:"+c+"(?="+p+"))?"),y||(m+="(?="+c+"|"+p+")")),new RegExp(m,Qs(t))}function ei(r,e,t){return r instanceof RegExp?ao(r,e):Array.isArray(r)?co(r,e,t):lo(r,e,t)}Le.parse=eo;Le.compile=to;Le.tokensToFunction=ro;Le.tokensToRegExp=so;const{hasOwnProperty:ho}=Object.prototype,ir=new Map;ir.set("|false",{keys:[],pattern:/(?:)/});function ls(r){try{return decodeURIComponent(r)}catch{return r}}function uo(r,e,t,s,i){t=!!t;const a=`${r}|${t}`;let c=ir.get(a);if(!c){const m=[];c={keys:m,pattern:Le(r,m,{end:t,strict:r===""})},ir.set(a,c)}const h=c.pattern.exec(e);if(!h)return null;const p=Object.assign({},i);for(let m=1;m<h.length;m++){const y=c.keys[m-1],b=y.name,w=h[m];(w!==void 0||!ho.call(p,b))&&(y.repeat?p[b]=w?w.split(y.delimiter).map(ls):[]:p[b]=w&&ls(w))}return{path:h[0],keys:(s||[]).concat(c.keys),params:p}}function ti(r,e,t,s,i){let a,c,h=0,p=r.path||"";return p.charAt(0)==="/"&&(t&&(p=p.substr(1)),t=!0),{next(m){if(r===m)return{done:!0};const y=r.__children=r.__children||r.children;if(!a&&(a=uo(p,e,!y,s,i),a))return{done:!1,value:{route:r,keys:a.keys,params:a.params,path:a.path}};if(a&&y)for(;h<y.length;){if(!c){const w=y[h];w.parent=r;let x=a.path.length;x>0&&e.charAt(x)==="/"&&(x+=1),c=ti(w,e.substr(x),t,a.keys,a.params)}const b=c.next(m);if(!b.done)return{done:!1,value:b.value};c=null,h++}return{done:!0}}}}function po(r){if(me(r.route.action))return r.route.action(r)}function fo(r,e){let t=e;for(;t;)if(t=t.parent,t===r)return!0;return!1}function mo(r){let e=`Path '${r.pathname}' is not properly resolved due to an error.`;const t=(r.route||{}).path;return t&&(e+=` Resolution had failed on route: '${t}'`),e}function go(r,e){const{route:t,path:s}=e;if(t&&!t.__synthetic){const i={path:s,route:t};if(!r.chain)r.chain=[];else if(t.parent){let a=r.chain.length;for(;a--&&r.chain[a].route&&r.chain[a].route!==t.parent;)r.chain.pop()}r.chain.push(i)}}class Ze{constructor(e,t={}){if(Object(e)!==e)throw new TypeError("Invalid routes");this.baseUrl=t.baseUrl||"",this.errorHandler=t.errorHandler,this.resolveRoute=t.resolveRoute||po,this.context=Object.assign({resolver:this},t.context),this.root=Array.isArray(e)?{path:"",__children:e,parent:null,__synthetic:!0}:e,this.root.parent=null}getRoutes(){return[...this.root.__children]}setRoutes(e){ns(e);const t=[...Ct(e)];this.root.__children=t}addRoutes(e){return ns(e),this.root.__children.push(...Ct(e)),this.getRoutes()}removeRoutes(){this.setRoutes([])}resolve(e){const t=Object.assign({},this.context,q(e)?{pathname:e}:e),s=ti(this.root,this.__normalizePathname(t.pathname),this.baseUrl),i=this.resolveRoute;let a=null,c=null,h=t;function p(m,y=a.value.route,b){const w=b===null&&a.value.route;return a=c||s.next(w),c=null,!m&&(a.done||!fo(y,a.value.route))?(c=a,Promise.resolve(Ce)):a.done?Promise.reject(Ys(t)):(h=Object.assign(h?{chain:h.chain?h.chain.slice(0):[]}:{},t,a.value),go(h,a.value),Promise.resolve(i(h)).then(x=>x!=null&&x!==Ce?(h.result=x.result||x,h):p(m,y,x)))}return t.next=p,Promise.resolve().then(()=>p(!0,this.root)).catch(m=>{const y=mo(h);if(m?console.warn(y):m=new Error(y),m.context=m.context||h,m instanceof DOMException||(m.code=m.code||500),this.errorHandler)return h.result=this.errorHandler(m),h;throw m})}static __createUrl(e,t){return new URL(e,t)}get __effectiveBaseUrl(){return this.baseUrl?this.constructor.__createUrl(this.baseUrl,document.baseURI||document.URL).href.replace(/[^\/]*$/,""):""}__normalizePathname(e){if(!this.baseUrl)return e;const t=this.__effectiveBaseUrl,s=this.constructor.__createUrl(e,t).href;if(s.slice(0,t.length)===t)return s.slice(t.length)}}Ze.pathToRegexp=Le;const{pathToRegexp:hs}=Ze,us=new Map;function ri(r,e,t){const s=e.name||e.component;if(s&&(r.has(s)?r.get(s).push(e):r.set(s,[e])),Array.isArray(t))for(let i=0;i<t.length;i++){const a=t[i];a.parent=e,ri(r,a,a.__children||a.children)}}function ps(r,e){const t=r.get(e);if(t&&t.length>1)throw new Error(`Duplicate route with name "${e}". Try seting unique 'name' route properties.`);return t&&t[0]}function ds(r){let e=r.path;return e=Array.isArray(e)?e[0]:e,e!==void 0?e:""}function yo(r,e={}){if(!(r instanceof Ze))throw new TypeError("An instance of Resolver is expected");const t=new Map;return(s,i)=>{let a=ps(t,s);if(!a&&(t.clear(),ri(t,r.root,r.root.__children),a=ps(t,s),!a))throw new Error(`Route "${s}" not found`);let c=us.get(a.fullPath);if(!c){let p=ds(a),m=a.parent;for(;m;){const x=ds(m);x&&(p=x.replace(/\/$/,"")+"/"+p.replace(/^\//,"")),m=m.parent}const y=hs.parse(p),b=hs.tokensToFunction(y),w=Object.create(null);for(let x=0;x<y.length;x++)q(y[x])||(w[y[x].name]=!0);c={toPath:b,keys:w},us.set(p,c),a.fullPath=p}let h=c.toPath(i,e)||"/";if(e.stringifyQueryParams&&i){const p={},m=Object.keys(i);for(let b=0;b<m.length;b++){const w=m[b];c.keys[w]||(p[w]=i[w])}const y=e.stringifyQueryParams(p);y&&(h+=y.charAt(0)==="?"?y:`?${y}`)}return h}}let fs=[];function bo(r){fs.forEach(e=>e.inactivate()),r.forEach(e=>e.activate()),fs=r}const wo=r=>{const e=getComputedStyle(r).getPropertyValue("animation-name");return e&&e!=="none"},_o=(r,e)=>{const t=()=>{r.removeEventListener("animationend",t),e()};r.addEventListener("animationend",t)};function ms(r,e){return r.classList.add(e),new Promise(t=>{if(wo(r)){const s=r.getBoundingClientRect(),i=`height: ${s.bottom-s.top}px; width: ${s.right-s.left}px`;r.setAttribute("style",`position: absolute; ${i}`),_o(r,()=>{r.classList.remove(e),r.removeAttribute("style"),t()})}else r.classList.remove(e),t()})}const vo=256;function Qt(r){return r!=null}function xo(r){const e=Object.assign({},r);return delete e.next,e}function M({pathname:r="",search:e="",hash:t="",chain:s=[],params:i={},redirectFrom:a,resolver:c},h){const p=s.map(m=>m.route);return{baseUrl:c&&c.baseUrl||"",pathname:r,search:e,hash:t,routes:p,route:h||p.length&&p[p.length-1]||null,params:i,redirectFrom:a,getUrl:(m={})=>vt(J.pathToRegexp.compile(si(p))(Object.assign({},i,m)),c)}}function gs(r,e){const t=Object.assign({},r.params);return{redirect:{pathname:e,from:r.pathname,params:t}}}function Eo(r,e){e.location=M(r);const t=r.chain.map(s=>s.route).indexOf(r.route);return r.chain[t].element=e,e}function _t(r,e,t){if(me(r))return r.apply(t,e)}function ys(r,e,t){return s=>{if(s&&(s.cancel||s.redirect))return s;if(t)return _t(t[r],e,t)}}function $o(r,e){if(!Array.isArray(r)&&!Rt(r))throw new Error(H(`Incorrect "children" value for the route ${e.path}: expected array or object, but got ${r}`));e.__children=[];const t=Ct(r);for(let s=0;s<t.length;s++)Ks(t[s]),e.__children.push(t[s])}function ft(r){if(r&&r.length){const e=r[0].parentNode;for(let t=0;t<r.length;t++)e.removeChild(r[t])}}function vt(r,e){const t=e.__effectiveBaseUrl;return t?e.constructor.__createUrl(r.replace(/^\//,""),t).pathname:r}function si(r){return r.map(e=>e.path).reduce((e,t)=>t.length?e.replace(/\/$/,"")+"/"+t.replace(/^\//,""):e,"")}class J extends Ze{constructor(e,t){const s=document.head.querySelector("base"),i=s&&s.getAttribute("href");super([],Object.assign({baseUrl:i&&Ze.__createUrl(i,document.URL).pathname.replace(/[^\/]*$/,"")},t)),this.resolveRoute=c=>this.__resolveRoute(c);const a=J.NavigationTrigger;J.setTriggers.apply(J,Object.keys(a).map(c=>a[c])),this.baseUrl,this.ready,this.ready=Promise.resolve(e),this.location,this.location=M({resolver:this}),this.__lastStartedRenderId=0,this.__navigationEventHandler=this.__onNavigationEvent.bind(this),this.setOutlet(e),this.subscribe(),this.__createdByRouter=new WeakMap,this.__addedByRouter=new WeakMap}__resolveRoute(e){const t=e.route;let s=Promise.resolve();me(t.children)&&(s=s.then(()=>t.children(xo(e))).then(a=>{!Qt(a)&&!me(t.children)&&(a=t.children),$o(a,t)}));const i={redirect:a=>gs(e,a),component:a=>{const c=document.createElement(a);return this.__createdByRouter.set(c,!0),c}};return s.then(()=>{if(this.__isLatestRender(e))return _t(t.action,[e,i],t)}).then(a=>{if(Qt(a)&&(a instanceof HTMLElement||a.redirect||a===Ce))return a;if(q(t.redirect))return i.redirect(t.redirect);if(t.bundle)return Jn(t.bundle).then(()=>{},()=>{throw new Error(H(`Bundle not found: ${t.bundle}. Check if the file name is correct`))})}).then(a=>{if(Qt(a))return a;if(q(t.component))return i.component(t.component)})}setOutlet(e){e&&this.__ensureOutlet(e),this.__outlet=e}getOutlet(){return this.__outlet}setRoutes(e,t=!1){return this.__previousContext=void 0,this.__urlForName=void 0,super.setRoutes(e),t||this.__onNavigationEvent(),this.ready}render(e,t){const s=++this.__lastStartedRenderId,i=Object.assign({search:"",hash:""},q(e)?{pathname:e}:e,{__renderId:s});return this.ready=this.resolve(i).then(a=>this.__fullyResolveChain(a)).then(a=>{if(this.__isLatestRender(a)){const c=this.__previousContext;if(a===c)return this.__updateBrowserHistory(c,!0),this.location;if(this.location=M(a),t&&this.__updateBrowserHistory(a,s===1),We("location-changed",{router:this,location:this.location}),a.__skipAttach)return this.__copyUnchangedElements(a,c),this.__previousContext=a,this.location;this.__addAppearingContent(a,c);const h=this.__animateIfNeeded(a);return this.__runOnAfterEnterCallbacks(a),this.__runOnAfterLeaveCallbacks(a,c),h.then(()=>{if(this.__isLatestRender(a))return this.__removeDisappearingContent(),this.__previousContext=a,this.location})}}).catch(a=>{if(s===this.__lastStartedRenderId)throw t&&this.__updateBrowserHistory(i),ft(this.__outlet&&this.__outlet.children),this.location=M(Object.assign(i,{resolver:this})),We("error",Object.assign({router:this,error:a},i)),a}),this.ready}__fullyResolveChain(e,t=e){return this.__findComponentContextAfterAllRedirects(t).then(s=>{const a=s!==t?s:e,h=vt(si(s.chain),s.resolver)===s.pathname,p=(m,y=m.route,b)=>m.next(void 0,y,b).then(w=>w===null||w===Ce?h?m:y.parent!==null?p(m,y.parent,w):w:w);return p(s).then(m=>{if(m===null||m===Ce)throw Ys(a);return m&&m!==Ce&&m!==s?this.__fullyResolveChain(a,m):this.__amendWithOnBeforeCallbacks(s)})})}__findComponentContextAfterAllRedirects(e){const t=e.result;return t instanceof HTMLElement?(Eo(e,t),Promise.resolve(e)):t.redirect?this.__redirect(t.redirect,e.__redirectCount,e.__renderId).then(s=>this.__findComponentContextAfterAllRedirects(s)):t instanceof Error?Promise.reject(t):Promise.reject(new Error(H(`Invalid route resolution result for path "${e.pathname}". Expected redirect object or HTML element, but got: "${Yn(t)}". Double check the action return value for the route.`)))}__amendWithOnBeforeCallbacks(e){return this.__runOnBeforeCallbacks(e).then(t=>t===this.__previousContext||t===e?t:this.__fullyResolveChain(t))}__runOnBeforeCallbacks(e){const t=this.__previousContext||{},s=t.chain||[],i=e.chain;let a=Promise.resolve();const c=()=>({cancel:!0}),h=p=>gs(e,p);if(e.__divergedChainIndex=0,e.__skipAttach=!1,s.length){for(let p=0;p<Math.min(s.length,i.length)&&!(s[p].route!==i[p].route||s[p].path!==i[p].path&&s[p].element!==i[p].element||!this.__isReusableElement(s[p].element,i[p].element));p=++e.__divergedChainIndex);if(e.__skipAttach=i.length===s.length&&e.__divergedChainIndex==i.length&&this.__isReusableElement(e.result,t.result),e.__skipAttach){for(let p=i.length-1;p>=0;p--)a=this.__runOnBeforeLeaveCallbacks(a,e,{prevent:c},s[p]);for(let p=0;p<i.length;p++)a=this.__runOnBeforeEnterCallbacks(a,e,{prevent:c,redirect:h},i[p]),s[p].element.location=M(e,s[p].route)}else for(let p=s.length-1;p>=e.__divergedChainIndex;p--)a=this.__runOnBeforeLeaveCallbacks(a,e,{prevent:c},s[p])}if(!e.__skipAttach)for(let p=0;p<i.length;p++)p<e.__divergedChainIndex?p<s.length&&s[p].element&&(s[p].element.location=M(e,s[p].route)):(a=this.__runOnBeforeEnterCallbacks(a,e,{prevent:c,redirect:h},i[p]),i[p].element&&(i[p].element.location=M(e,i[p].route)));return a.then(p=>{if(p){if(p.cancel)return this.__previousContext.__renderId=e.__renderId,this.__previousContext;if(p.redirect)return this.__redirect(p.redirect,e.__redirectCount,e.__renderId)}return e})}__runOnBeforeLeaveCallbacks(e,t,s,i){const a=M(t);return e.then(c=>{if(this.__isLatestRender(t))return ys("onBeforeLeave",[a,s,this],i.element)(c)}).then(c=>{if(!(c||{}).redirect)return c})}__runOnBeforeEnterCallbacks(e,t,s,i){const a=M(t,i.route);return e.then(c=>{if(this.__isLatestRender(t))return ys("onBeforeEnter",[a,s,this],i.element)(c)})}__isReusableElement(e,t){return e&&t?this.__createdByRouter.get(e)&&this.__createdByRouter.get(t)?e.localName===t.localName:e===t:!1}__isLatestRender(e){return e.__renderId===this.__lastStartedRenderId}__redirect(e,t,s){if(t>vo)throw new Error(H(`Too many redirects when rendering ${e.from}`));return this.resolve({pathname:this.urlForPath(e.pathname,e.params),redirectFrom:e.from,__redirectCount:(t||0)+1,__renderId:s})}__ensureOutlet(e=this.__outlet){if(!(e instanceof Node))throw new TypeError(H(`Expected router outlet to be a valid DOM Node (but got ${e})`))}__updateBrowserHistory({pathname:e,search:t="",hash:s=""},i){if(window.location.pathname!==e||window.location.search!==t||window.location.hash!==s){const a=i?"replaceState":"pushState";window.history[a](null,document.title,e+t+s),window.dispatchEvent(new PopStateEvent("popstate",{state:"vaadin-router-ignore"}))}}__copyUnchangedElements(e,t){let s=this.__outlet;for(let i=0;i<e.__divergedChainIndex;i++){const a=t&&t.chain[i].element;if(a)if(a.parentNode===s)e.chain[i].element=a,s=a;else break}return s}__addAppearingContent(e,t){this.__ensureOutlet(),this.__removeAppearingContent();const s=this.__copyUnchangedElements(e,t);this.__appearingContent=[],this.__disappearingContent=Array.from(s.children).filter(a=>this.__addedByRouter.get(a)&&a!==e.result);let i=s;for(let a=e.__divergedChainIndex;a<e.chain.length;a++){const c=e.chain[a].element;c&&(i.appendChild(c),this.__addedByRouter.set(c,!0),i===s&&this.__appearingContent.push(c),i=c)}}__removeDisappearingContent(){this.__disappearingContent&&ft(this.__disappearingContent),this.__disappearingContent=null,this.__appearingContent=null}__removeAppearingContent(){this.__disappearingContent&&this.__appearingContent&&(ft(this.__appearingContent),this.__disappearingContent=null,this.__appearingContent=null)}__runOnAfterLeaveCallbacks(e,t){if(t)for(let s=t.chain.length-1;s>=e.__divergedChainIndex&&this.__isLatestRender(e);s--){const i=t.chain[s].element;if(i)try{const a=M(e);_t(i.onAfterLeave,[a,{},t.resolver],i)}finally{this.__disappearingContent.indexOf(i)>-1&&ft(i.children)}}}__runOnAfterEnterCallbacks(e){for(let t=e.__divergedChainIndex;t<e.chain.length&&this.__isLatestRender(e);t++){const s=e.chain[t].element||{},i=M(e,e.chain[t].route);_t(s.onAfterEnter,[i,{},e.resolver],s)}}__animateIfNeeded(e){const t=(this.__disappearingContent||[])[0],s=(this.__appearingContent||[])[0],i=[],a=e.chain;let c;for(let h=a.length;h>0;h--)if(a[h-1].route.animate){c=a[h-1].route.animate;break}if(t&&s&&c){const h=Rt(c)&&c.leave||"leaving",p=Rt(c)&&c.enter||"entering";i.push(ms(t,h)),i.push(ms(s,p))}return Promise.all(i).then(()=>e)}subscribe(){window.addEventListener("vaadin-router-go",this.__navigationEventHandler)}unsubscribe(){window.removeEventListener("vaadin-router-go",this.__navigationEventHandler)}__onNavigationEvent(e){const{pathname:t,search:s,hash:i}=e?e.detail:window.location;q(this.__normalizePathname(t))&&(e&&e.preventDefault&&e.preventDefault(),this.render({pathname:t,search:s,hash:i},!0))}static setTriggers(...e){bo(e)}urlForName(e,t){return this.__urlForName||(this.__urlForName=yo(this)),vt(this.__urlForName(e,t),this)}urlForPath(e,t){return vt(J.pathToRegexp.compile(e)(t),this)}static go(e){const{pathname:t,search:s,hash:i}=q(e)?this.__createUrl(e,"http://a"):e;return We("go",{pathname:t,search:s,hash:i})}}const Ao=/\/\*[\*!]\s+vaadin-dev-mode:start([\s\S]*)vaadin-dev-mode:end\s+\*\*\//i,xt=window.Vaadin&&window.Vaadin.Flow&&window.Vaadin.Flow.clients;function ko(){function r(){return!0}return ii(r)}function So(){try{return To()?!0:Co()?xt?!Po():!ko():!1}catch{return!1}}function To(){return localStorage.getItem("vaadin.developmentmode.force")}function Co(){return["localhost","127.0.0.1"].indexOf(window.location.hostname)>=0}function Po(){return!!(xt&&Object.keys(xt).map(e=>xt[e]).filter(e=>e.productionMode).length>0)}function ii(r,e){if(typeof r!="function")return;const t=Ao.exec(r.toString());if(t)try{r=new Function(t[1])}catch(s){console.log("vaadin-development-mode-detector: uncommentAndRun() failed",s)}return r(e)}window.Vaadin=window.Vaadin||{};const bs=function(r,e){if(window.Vaadin.developmentMode)return ii(r,e)};window.Vaadin.developmentMode===void 0&&(window.Vaadin.developmentMode=So());function Oo(){}const Ro=function(){if(typeof bs=="function")return bs(Oo)};window.Vaadin=window.Vaadin||{};window.Vaadin.registrations=window.Vaadin.registrations||[];window.Vaadin.registrations.push({is:"@vaadin/router",version:"1.7.4"});Ro();J.NavigationTrigger={POPSTATE:Zn,CLICK:Xn};var Bo=Object.defineProperty,Uo=Object.getOwnPropertyDescriptor,_r=(r,e,t,s)=>{for(var i=s>1?void 0:s?Uo(e,t):e,a=r.length-1,c;a>=0;a--)(c=r[a])&&(i=(s?c(e,t,i):c(i))||i);return s&&i&&Bo(e,t,i),i};let et=class extends S{constructor(r){super(),this.redirectAfterSubmit=!1,this.profile=r}_handleSubmit(r){r.preventDefault();const e=r.target,t=new FormData(e),s={...this.profile,name:t.get("name"),bio:t.get("bio"),musicTaste:t.get("musicTaste"),timezone:t.get("timezone"),spotify:t.get("spotify")==="true"},i=new CustomEvent("profile-update",{detail:{profile:s},bubbles:!0,composed:!0});console.log("profile-update Event being sent to DOM"),this.dispatchEvent(i);const a=new CustomEvent("update-using",{detail:{profile:s},bubbles:!0,composed:!0});console.log("profile update event being sent to profile component to update using"),this.dispatchEvent(a),this.requestUpdate(),this.redirectAfterSubmit&&J.go("/app/home")}render(){var r,e,t,s,i,a;return _`
    ...
    `}};ge.styles=An;at([v()],ge.prototype,"path",2);at([v()],ge.prototype,"editMode",2);at([v()],ge.prototype,"profileEditText",2);at([v({attribute:!1})],ge.prototype,"using",2);ge=at([T("user-profile")],ge);var Do=Object.defineProperty,Fo=Object.getOwnPropertyDescriptor,ni=(r,e,t,s)=>{for(var i=s>1?void 0:s?Fo(e,t):e,a=r.length-1,c;a>=0;a--)(c=r[a])&&(i=(s?c(e,t,i):c(i))||i);return s&&i&&Do(e,t,i),i};let nr=class extends S{constructor(){super(...arguments),this.router=new J(this),this.routes=[]}connectedCallback(){super.connectedCallback(),this.router.setRoutes(this.routes),console.log("Router:",this.routes)}render(){return _`<slot></slot>`}};ni([v({attribute:!1})],nr.prototype,"routes",2);nr=ni([T("vaadin-router")],nr);const No=P`
  :host {
    display: block;
    margin: auto;
  }
...
`;var wa=Object.defineProperty,_a=Object.getOwnPropertyDescriptor,Sr=(r,e,t,s)=>{for(var i=s>1?void 0:s?_a(e,t):e,a=r.length-1,c;a>=0;a--)(c=r[a])&&(i=(s?c(e,t,i):c(i))||i);return s&&i&&wa(e,t,i),i};let st=class extends S{constructor(){super(...arguments),this.topTracks=[],this.selectedTracks=[]}_clearTopTracks(){$r(this)}_clearSelectedTracks(){Ar(this)}render(){return _`
      <section class="search-and-selected">
        <section class="query-results">
    ...
    `}};st.styles=[ba];Sr([A()],st.prototype,"topTracks",2);Sr([A()],st.prototype,"selectedTracks",2);st=Sr([T("single-song-ui")],st);var va=Object.defineProperty,xa=Object.getOwnPropertyDescriptor,re=(r,e,t,s)=>{for(var i=s>1?void 0:s?xa(e,t):e,a=r.length-1,c;a>=0;a--)(c=r[a])&&(i=(s?c(e,t,i):c(i))||i);return s&&i&&va(e,t,i),i};let V=class extends S{constructor(){super(),this.submissionSuccess=null,this.expandedText="unexpanded",this.requestedSearchQuery="",this.accessToken="",this.topTracks=[],this.selectedTracks=[],this.expandedClass="feed-single-post",this.multiPicker=!1,this.addEventListener("track-selected",r=>{const e=r;this._selectTrack(e.detail.track)}),this.addEventListener("clear-tracks",r=>{console.log("Within Clear Tracks Listener"),r.detail.topOrSelected==="top"?(console.log("Within Top, executing clear top tracks"),this._clearTopTracks()):(console.log("Within Selected, executing clear selected tracks"),this._clearSelectedTracks())})}async _authenticate(){await li(this)}async _recommendTracks(r){await fa(r,this)}_handleSubmit(r){da(r,this)}_clearTopTracks(){$r(this)}_clearSelectedTracks(){Ar(this)}_selectTrack(r){ua(this,r)}async fetchTopTracks(r){await pa(this,r)}async searchSpotify(){await hi(this)}render(){return _`
    ...
    `}};V.styles=[ha];re([A()],V.prototype,"submissionSuccess",2);re([v()],V.prototype,"expandedText",2);re([v({type:String})],V.prototype,"requestedSearchQuery",2);re([v({type:String})],V.prototype,"accessToken",2);re([v()],V.prototype,"topTracks",2);re([v()],V.prototype,"selectedTracks",2);re([A()],V.prototype,"expandedClass",2);re([v({type:Boolean})],V.prototype,"multiPicker",2);V=re([T("song-picker")],V);var Ea=Object.defineProperty,$a=Object.getOwnPropertyDescriptor,se=(r,e,t,s)=>{for(var i=s>1?void 0:s?$a(e,t):e,a=r.length-1,c;a>=0;a--)(c=r[a])&&(i=(s?c(e,t,i):c(i))||i);return s&&i&&Ea(e,t,i),i};let W=class extends S{constructor(){super(...arguments),this.getPostComments=[],this.expanded=!1,this.submissionSuccess=null,this.expandedText="unexpanded",this.requestedSearchQuery="",this.accessToken="",this.expandedClass="feed-single-post"}_calculateTimeFromDate(){var i;const r=(i=this.post)!=null&&i.postTime?new Date(this.post.postTime):void 0;if(!r)return console.error("Posted time is undefined"),"Post time cannot be found.";let s=(new Date().getTime()-r.getTime())/(1e3*60*60);return s=Math.round(s),s<1?"Less than an hour ago.":s>23?`${s%24} days ago`:`${s} hours ago`}_expand(){this.expanded=!this.expanded,this.expandedClass==="feed-single-post"?this.expandedClass="feed-single-post-expanded":this.expandedClass="feed-single-post"}connectedCallback(){var r;super.connectedCallback(),(!this.getPostComments||this.getPostComments.length===0)&&(this.getPostComments=((r=this.post)==null?void 0:r.comments)||[])}async _handleCommentAdded(){var e;console.log("Comment Created, Now Refreshing Component");const r="http://localhost:3000";if(console.log("SERVER URL FROM COMMENT ADDED: ",r),!((e=this.post)!=null&&e._id)){console.error("Post ID is undefined.");return}try{const t=await fetch(`${r}/comments/${this.post._id}`,{method:"GET"});if(!t.ok)throw new Error("Failed to fetch comments");const s=await t.json();this.getPostComments=[...s]}catch(t){console.error("Error fetching comments:",t)}}render(){var e,t;const r=this._calculateTimeFromDate();return _`
      <section class="${this.expandedClass}">
        ...
        ${this.expanded?_` <song-picker .multiPicker=${!0}></song-picker>`:""}
      </section>
