 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const pn={attribute:!0,type:String,converter:At,reflect:!1,hasChanged:ys},fn=(s=pn,e,t)=>{const{kind:r,metadata:i}=t;let o=globalThis.litPropertyMetadata.get(i);if(o===void 0&&globalThis.litPropertyMetadata.set(i,o=new Map),o.set(t.name,s),r==="accessor"){const{name:c}=t;return{set(h){const u=e.get.call(this);e.set.call(this,h),this.requestUpdate(c,u,s)},init(h){return h!==void 0&&this.P(c,void 0,s),h}}}if(r==="setter"){const{name:c}=t;return function(h){const u=this[c];e.call(this,h),this.requestUpdate(c,u,s)}}throw Error("Unsupported decorator location: "+r)};function _(s){return(e,t)=>typeof t=="object"?fn(s,e,t):((r,i,o)=>{const c=i.hasOwnProperty(o);return i.constructor.createProperty(o,c?{...r,wrapped:!0}:r),c?Object.getOwnPropertyDescriptor(i,o):void 0})(s,e,t)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function E(s){return _({...s,state:!0,attribute:!1})}/**
 * @license
...
`;var Ln=Object.defineProperty,Dn=Object.getOwnPropertyDescriptor,_s=(s,e,t,r)=>{for(var i=r>1?void 0:r?Dn(e,t):e,o=s.length-1,c;o>=0;o--)(c=s[o])&&(i=(r?c(e,t,i):c(i))||i);return r&&i&&Ln(e,t,i),i};let et=class extends S{constructor(){super(...arguments),this.artists=[],this.listAttributes=""}render(){return y`
    ...
    `}};et.styles=[In];_s([_({type:Array})],et.prototype,"artists",2);_s([_({type:String})],et.prototype,"listAttributes",2);et=_s([A("favorites-list")],et);const Fn=P`
  :host {
...
`;var Nn=Object.defineProperty,Mn=Object.getOwnPropertyDescriptor,_e=(s,e,t,r)=>{for(var i=r>1?void 0:r?Mn(e,t):e,o=s.length-1,c;o>=0;o--)(c=s[o])&&(i=(r?c(e,t,i):c(i))||i);return r&&i&&Nn(e,t,i),i};let ie=class extends S{constructor(){super(...arguments),this.open=!1,this.align="left",this.profileImageLink=""}_signOutUser(){console.log("Log Out Clicked.");const s=new CustomEvent("userSignOutTriggeredWithinDropDown",{bubbles:!0,composed:!0});this.dispatchEvent(s)}render(){return y`
    ...
    `}_handleChange(s){const e=s.target;this._toggle(e.checked)}_toggle(s){this.open=s,this._toggleClickAway(s)}_toggleClickAway(s){const e=t=>{t.composedPath().includes(this)?t.stopPropagation():this._toggle(!1)};s?document.addEventListener("click",e):document.removeEventListener("click",e)}};ie.styles=[Fn];_e([_({reflect:!0,type:Boolean})],ie.prototype,"open",2);_e([_()],ie.prototype,"align",2);_e([_()],ie.prototype,"profileImage",2);_e([_()],ie.prototype,"profileUserID",2);_e([_()],ie.prototype,"profileDescription",2);_e([_()],ie.prototype,"profileImageLink",2);ie=_e([A("drop-down")],ie);const jn=P`
  :host {
    display: block;
...
`;var qn=Object.defineProperty,Vn=Object.getOwnPropertyDescriptor,Yr=(s,e,t,r)=>{for(var i=r>1?void 0:r?Vn(e,t):e,o=s.length-1,c;o>=0;o--)(c=s[o])&&(i=(r?c(e,t,i):c(i))||i);return r&&i&&qn(e,t,i),i};let Pt=class extends S{constructor(){super(...arguments),this.on=!1}render(){return y`<label>
      <slot>Light Mode</slot>
      <span class="slider">
        <input type="checkbox" @change=${this._handleChange} />
      </span>
    </label>`}_handleChange(s){const e=s.target,t=new Event(s.type,{bubbles:!0,composed:!0});document.body.classList.contains("dark-mode")?(document.body.classList.remove("dark-mode"),document.body.classList.add("light-mode")):(document.body.classList.remove("light-mode"),document.body.classList.add("dark-mode")),this.on=e==null?void 0:e.checked,this.dispatchEvent(t)}};Pt.styles=[jn];Yr([_({reflect:!0,type:Boolean})],Pt.prototype,"on",2);Pt=Yr([A("color-mode-switch")],Pt);const zn=P`
  .user-friend {
    border: 1.5px solid var(--section-border-color);
    width: 120px;
    height: 120px;
...
`;var Yn=Object.defineProperty,Kn=Object.getOwnPropertyDescriptor,xs=(s,e,t,r)=>{for(var i=r>1?void 0:r?Kn(e,t):e,o=s.length-1,c;o>=0;o--)(c=s[o])&&(i=(r?c(e,t,i):c(i))||i);return r&&i&&Yn(e,t,i),i};let tt=class extends S{constructor(){super(...arguments),this.on=!1,this.filteredState=""}render(){return y`<label>
    ...
    </label>`}_onInput(){this.filteredState=="unsorted"?this.filteredState="sorted":this.filteredState="unsorted",this.dispatchEvent(new Event("state-changed"))}};tt.styles=[Gn];xs([_({reflect:!0,type:Boolean})],tt.prototype,"on",2);xs([_()],tt.prototype,"filteredState",2);tt=xs([A("toggle-switch")],tt);const Jn=P`
...
`;function Ct(s){return s=s||[],Array.isArray(s)?s:[s]}function Y(s){return`[Vaadin.Router] ${s}`}function Xn(s){if(typeof s!="object")return String(s);const e=Object.prototype.toString.call(s).match(/ (.*)\]$/)[1];return e==="Object"||e==="Array"?`${e} ${JSON.stringify(s)}`:e}const Rt="module",Ot="nomodule",ns=[Rt,Ot];function nr(s){if(!s.match(/.+\.[m]?js$/))throw new Error(Y(`Unsupported type for bundle "${s}": .js or .mjs expected.`))}function Kr(s){if(!s||!G(s.path))throw new Error(Y('Expected route config to be an object with a "path" string property, or an array of such objects'));const e=s.bundle,t=["component","redirect","bundle"];if(!ge(s.action)&&!Array.isArray(s.children)&&!ge(s.children)&&!Ut(e)&&!t.some(r=>G(s[r])))throw new Error(Y(`Expected route config "${s.path}" to include either "${t.join('", "')}" or "action" function but none found.`));if(e)if(G(e))nr(e);else if(ns.some(r=>r in e))ns.forEach(r=>r in e&&nr(e[r]));else throw new Error(Y('Expected route bundle to include either "'+Ot+'" or "'+Rt+'" keys, or both'));s.redirect&&["bundle","component"].forEach(r=>{r in s&&console.warn(Y(`Route config "${s.path}" has both "redirect" and "${r}" properties, and "redirect" will always override the latter. Did you mean to only use "${r}"?`))})}function or(s){Ct(s).forEach(e=>Kr(e))}function ar(s,e){let t=document.head.querySelector('script[src="'+s+'"][async]');return t||(t=document.createElement("script"),t.setAttribute("src",s),e===Rt?t.setAttribute("type",Rt):e===Ot&&t.setAttribute(Ot,""),t.async=!0),new Promise((r,i)=>{t.onreadystatechange=t.onload=o=>{t.__dynamicImportLoaded=!0,r(o)},t.onerror=o=>{t.parentNode&&t.parentNode.removeChild(t),i(o)},t.parentNode===null?document.head.appendChild(t):t.__dynamicImportLoaded&&r()})}function Qn(s){return G(s)?ar(s):Promise.race(ns.filter(e=>e in s).map(e=>ar(s[e],e)))}function Ke(s,e){return!window.dispatchEvent(new CustomEvent(`vaadin-router-${s}`,{cancelable:s==="go",detail:e}))}function Ut(s){return typeof s=="object"&&!!s}function ge(s){return typeof s=="function"}function G(s){return typeof s=="string"}function Jr(s){const e=new Error(Y(`Page not found (${s.pathname})`));return e.context=s,e.code=404,e}const Pe=new class{};function Zn(s){const e=s.port,t=s.protocol,o=t==="http:"&&e==="80"||t==="https:"&&e==="443"?s.hostname:s.host;return`${t}//${o}`}function cr(s){if(s.defaultPrevented||s.button!==0||s.shiftKey||s.ctrlKey||s.altKey||s.metaKey)return;let e=s.target;const t=s.composedPath?s.composedPath():s.path||[];for(let h=0;h<t.length;h++){const u=t[h];if(u.nodeName&&u.nodeName.toLowerCase()==="a"){e=u;break}}for(;e&&e.nodeName.toLowerCase()!=="a";)e=e.parentNode;if(!e||e.nodeName.toLowerCase()!=="a"||e.target&&e.target.toLowerCase()!=="_self"||e.hasAttribute("download")||e.hasAttribute("router-ignore")||e.pathname===window.location.pathname&&e.hash!==""||(e.origin||Zn(e))!==window.location.origin)return;const{pathname:i,search:o,hash:c}=e;Ke("go",{pathname:i,search:o,hash:c})&&(s.preventDefault(),s&&s.type==="click"&&window.scrollTo(0,0))}const eo={activate(){window.document.addEventListener("click",cr)},inactivate(){window.document.removeEventListener("click",cr)}},to=/Trident/.test(navigator.userAgent);to&&!ge(window.PopStateEvent)&&(window.PopStateEvent=function(s,e){e=e||{};var t=document.createEvent("Event");return t.initEvent(s,!!e.bubbles,!!e.cancelable),t.state=e.state||null,t},window.PopStateEvent.prototype=window.Event.prototype);function lr(s){if(s.state==="vaadin-router-ignore")return;const{pathname:e,search:t,hash:r}=window.location;Ke("go",{pathname:e,search:t,hash:r})}const so={activate(){window.addEventListener("popstate",lr)},inactivate(){window.removeEventListener("popstate",lr)}};var Ne=si,ro=Es,io=co,no=Zr,oo=ti,Xr="/",Qr="./",ao=new RegExp(["(\\\\.)","(?:\\:(\\w+)(?:\\(((?:\\\\.|[^\\\\()])+)\\))?|\\(((?:\\\\.|[^\\\\()])+)\\))([+*?])?"].join("|"),"g");function Es(s,e){for(var t=[],r=0,i=0,o="",c=e&&e.delimiter||Xr,h=e&&e.delimiters||Qr,u=!1,m;(m=ao.exec(s))!==null;){var b=m[0],w=m[1],v=m.index;if(o+=s.slice(i,v),i=v+b.length,w){o+=w[1],u=!0;continue}var x="",M=s[i],de=m[2],Ht=m[3],je=m[4],xe=m[5];if(!u&&o.length){var Ee=o.length-1;h.indexOf(o[Ee])>-1&&(x=o[Ee],o=o.slice(0,Ee))}o&&(t.push(o),o="",u=!1);var Wt=x!==""&&M!==void 0&&M!==x,re=xe==="+"||xe==="*",ut=xe==="?"||xe==="*",qe=x||c,pt=Ht||je;t.push({name:de||r++,prefix:x,delimiter:qe,optional:ut,repeat:re,partial:Wt,pattern:pt?lo(pt):"[^"+oe(qe)+"]+?"})}return(o||i<s.length)&&t.push(o+s.substr(i)),t}function co(s,e){return Zr(Es(s,e))}function Zr(s){for(var e=new Array(s.length),t=0;t<s.length;t++)typeof s[t]=="object"&&(e[t]=new RegExp("^(?:"+s[t].pattern+")$"));return function(r,i){for(var o="",c=i&&i.encode||encodeURIComponent,h=0;h<s.length;h++){var u=s[h];if(typeof u=="string"){o+=u;continue}var m=r?r[u.name]:void 0,b;if(Array.isArray(m)){if(!u.repeat)throw new TypeError('Expected "'+u.name+'" to not repeat, but got array');if(m.length===0){if(u.optional)continue;throw new TypeError('Expected "'+u.name+'" to not be empty')}for(var w=0;w<m.length;w++){if(b=c(m[w],u),!e[h].test(b))throw new TypeError('Expected all "'+u.name+'" to match "'+u.pattern+'"');o+=(w===0?u.prefix:u.delimiter)+b}continue}if(typeof m=="string"||typeof m=="number"||typeof m=="boolean"){if(b=c(String(m),u),!e[h].test(b))throw new TypeError('Expected "'+u.name+'" to match "'+u.pattern+'", but got "'+b+'"');o+=u.prefix+b;continue}if(u.optional){u.partial&&(o+=u.prefix);continue}throw new TypeError('Expected "'+u.name+'" to be '+(u.repeat?"an array":"a string"))}return o}}function oe(s){return s.replace(/([.+*?=^!:${}()[\]|/\\])/g,"\\$1")}function lo(s){return s.replace(/([=!:$/()])/g,"\\$1")}function ei(s){return s&&s.sensitive?"":"i"}function ho(s,e){if(!e)return s;var t=s.source.match(/\((?!\?)/g);if(t)for(var r=0;r<t.length;r++)e.push({name:r,prefix:null,delimiter:null,optional:!1,repeat:!1,partial:!1,pattern:null});return s}function uo(s,e,t){for(var r=[],i=0;i<s.length;i++)r.push(si(s[i],e,t).source);return new RegExp("(?:"+r.join("|")+")",ei(t))}function po(s,e,t){return ti(Es(s,t),e,t)}function ti(s,e,t){t=t||{};for(var r=t.strict,i=t.start!==!1,o=t.end!==!1,c=oe(t.delimiter||Xr),h=t.delimiters||Qr,u=[].concat(t.endsWith||[]).map(oe).concat("$").join("|"),m=i?"^":"",b=s.length===0,w=0;w<s.length;w++){var v=s[w];if(typeof v=="string")m+=oe(v),b=w===s.length-1&&h.indexOf(v[v.length-1])>-1;else{var x=v.repeat?"(?:"+v.pattern+")(?:"+oe(v.delimiter)+"(?:"+v.pattern+"))*":v.pattern;e&&e.push(v),v.optional?v.partial?m+=oe(v.prefix)+"("+x+")?":m+="(?:"+oe(v.prefix)+"("+x+"))?":m+=oe(v.prefix)+"("+x+")"}}return o?(r||(m+="(?:"+c+")?"),m+=u==="$"?"$":"(?="+u+")"):(r||(m+="(?:"+c+"(?="+u+"))?"),b||(m+="(?="+c+"|"+u+")")),new RegExp(m,ei(t))}function si(s,e,t){return s instanceof RegExp?ho(s,e):Array.isArray(s)?uo(s,e,t):po(s,e,t)}Ne.parse=ro;Ne.compile=io;Ne.tokensToFunction=no;Ne.tokensToRegExp=oo;const{hasOwnProperty:fo}=Object.prototype,os=new Map;os.set("|false",{keys:[],pattern:/(?:)/});function hr(s){try{return decodeURIComponent(s)}catch{return s}}function mo(s,e,t,r,i){t=!!t;const o=`${s}|${t}`;let c=os.get(o);if(!c){const m=[];c={keys:m,pattern:Ne(s,m,{end:t,strict:s===""})},os.set(o,c)}const h=c.pattern.exec(e);if(!h)return null;const u=Object.assign({},i);for(let m=1;m<h.length;m++){const b=c.keys[m-1],w=b.name,v=h[m];(v!==void 0||!fo.call(u,w))&&(b.repeat?u[w]=v?v.split(b.delimiter).map(hr):[]:u[w]=v&&hr(v))}return{path:h[0],keys:(r||[]).concat(c.keys),params:u}}function ri(s,e,t,r,i){let o,c,h=0,u=s.path||"";return u.charAt(0)==="/"&&(t&&(u=u.substr(1)),t=!0),{next(m){if(s===m)return{done:!0};const b=s.__children=s.__children||s.children;if(!o&&(o=mo(u,e,!b,r,i),o))return{done:!1,value:{route:s,keys:o.keys,params:o.params,path:o.path}};if(o&&b)for(;h<b.length;){if(!c){const v=b[h];v.parent=s;let x=o.path.length;x>0&&e.charAt(x)==="/"&&(x+=1),c=ri(v,e.substr(x),t,o.keys,o.params)}const w=c.next(m);if(!w.done)return{done:!1,value:w.value};c=null,h++}return{done:!0}}}}function go(s){if(ge(s.route.action))return s.route.action(s)}function bo(s,e){let t=e;for(;t;)if(t=t.parent,t===s)return!0;return!1}function yo(s){let e=`Path '${s.pathname}' is not properly resolved due to an error.`;const t=(s.route||{}).path;return t&&(e+=` Resolution had failed on route: '${t}'`),e}function wo(s,e){const{route:t,path:r}=e;if(t&&!t.__synthetic){const i={path:r,route:t};if(!s.chain)s.chain=[];else if(t.parent){let o=s.chain.length;for(;o--&&s.chain[o].route&&s.chain[o].route!==t.parent;)s.chain.pop()}s.chain.push(i)}}class st{constructor(e,t={}){if(Object(e)!==e)throw new TypeError("Invalid routes");this.baseUrl=t.baseUrl||"",this.errorHandler=t.errorHandler,this.resolveRoute=t.resolveRoute||go,this.context=Object.assign({resolver:this},t.context),this.root=Array.isArray(e)?{path:"",__children:e,parent:null,__synthetic:!0}:e,this.root.parent=null}getRoutes(){return[...this.root.__children]}setRoutes(e){or(e);const t=[...Ct(e)];this.root.__children=t}addRoutes(e){return or(e),this.root.__children.push(...Ct(e)),this.getRoutes()}removeRoutes(){this.setRoutes([])}resolve(e){const t=Object.assign({},this.context,G(e)?{pathname:e}:e),r=ri(this.root,this.__normalizePathname(t.pathname),this.baseUrl),i=this.resolveRoute;let o=null,c=null,h=t;function u(m,b=o.value.route,w){const v=w===null&&o.value.route;return o=c||r.next(v),c=null,!m&&(o.done||!bo(b,o.value.route))?(c=o,Promise.resolve(Pe)):o.done?Promise.reject(Jr(t)):(h=Object.assign(h?{chain:h.chain?h.chain.slice(0):[]}:{},t,o.value),wo(h,o.value),Promise.resolve(i(h)).then(x=>x!=null&&x!==Pe?(h.result=x.result||x,h):u(m,b,x)))}return t.next=u,Promise.resolve().then(()=>u(!0,this.root)).catch(m=>{const b=yo(h);if(m?console.warn(b):m=new Error(b),m.context=m.context||h,m instanceof DOMException||(m.code=m.code||500),this.errorHandler)return h.result=this.errorHandler(m),h;throw m})}static __createUrl(e,t){return new URL(e,t)}get __effectiveBaseUrl(){return this.baseUrl?this.constructor.__createUrl(this.baseUrl,document.baseURI||document.URL).href.replace(/[^\/]*$/,""):""}__normalizePathname(e){if(!this.baseUrl)return e;const t=this.__effectiveBaseUrl,r=this.constructor.__createUrl(e,t).href;if(r.slice(0,t.length)===t)return r.slice(t.length)}}st.pathToRegexp=Ne;const{pathToRegexp:dr}=st,ur=new Map;function ii(s,e,t){const r=e.name||e.component;if(r&&(s.has(r)?s.get(r).push(e):s.set(r,[e])),Array.isArray(t))for(let i=0;i<t.length;i++){const o=t[i];o.parent=e,ii(s,o,o.__children||o.children)}}function pr(s,e){const t=s.get(e);if(t&&t.length>1)throw new Error(`Duplicate route with name "${e}". Try seting unique 'name' route properties.`);return t&&t[0]}function fr(s){let e=s.path;return e=Array.isArray(e)?e[0]:e,e!==void 0?e:""}function vo(s,e={}){if(!(s instanceof st))throw new TypeError("An instance of Resolver is expected");const t=new Map;return(r,i)=>{let o=pr(t,r);if(!o&&(t.clear(),ii(t,s.root,s.root.__children),o=pr(t,r),!o))throw new Error(`Route "${r}" not found`);let c=ur.get(o.fullPath);if(!c){let u=fr(o),m=o.parent;for(;m;){const x=fr(m);x&&(u=x.replace(/\/$/,"")+"/"+u.replace(/^\//,"")),m=m.parent}const b=dr.parse(u),w=dr.tokensToFunction(b),v=Object.create(null);for(let x=0;x<b.length;x++)G(b[x])||(v[b[x].name]=!0);c={toPath:w,keys:v},ur.set(u,c),o.fullPath=u}let h=c.toPath(i,e)||"/";if(e.stringifyQueryParams&&i){const u={},m=Object.keys(i);for(let w=0;w<m.length;w++){const v=m[w];c.keys[v]||(u[v]=i[v])}const b=e.stringifyQueryParams(u);b&&(h+=b.charAt(0)==="?"?b:`?${b}`)}return h}}let mr=[];function _o(s){mr.forEach(e=>e.inactivate()),s.forEach(e=>e.activate()),mr=s}const xo=s=>{const e=getComputedStyle(s).getPropertyValue("animation-name");return e&&e!=="none"},Eo=(s,e)=>{const t=()=>{s.removeEventListener("animationend",t),e()};s.addEventListener("animationend",t)};function gr(s,e){return s.classList.add(e),new Promise(t=>{if(xo(s)){const r=s.getBoundingClientRect(),i=`height: ${r.bottom-r.top}px; width: ${r.right-r.left}px`;s.setAttribute("style",`position: absolute; ${i}`),Eo(s,()=>{s.classList.remove(e),s.removeAttribute("style"),t()})}else s.classList.remove(e),t()})}const $o=256;function es(s){return s!=null}function ko(s){const e=Object.assign({},s);return delete e.next,e}function H({pathname:s="",search:e="",hash:t="",chain:r=[],params:i={},redirectFrom:o,resolver:c},h){const u=r.map(m=>m.route);return{baseUrl:c&&c.baseUrl||"",pathname:s,search:e,hash:t,routes:u,route:h||u.length&&u[u.length-1]||null,params:i,redirectFrom:o,getUrl:(m={})=>xt(K.pathToRegexp.compile(ni(u))(Object.assign({},i,m)),c)}}function br(s,e){const t=Object.assign({},s.params);return{redirect:{pathname:e,from:s.pathname,params:t}}}function So(s,e){e.location=H(s);const t=s.chain.map(r=>r.route).indexOf(s.route);return s.chain[t].element=e,e}function _t(s,e,t){if(ge(s))return s.apply(t,e)}function yr(s,e,t){return r=>{if(r&&(r.cancel||r.redirect))return r;if(t)return _t(t[s],e,t)}}function Ao(s,e){if(!Array.isArray(s)&&!Ut(s))throw new Error(Y(`Incorrect "children" value for the route ${e.path}: expected array or object, but got ${s}`));e.__children=[];const t=Ct(s);for(let r=0;r<t.length;r++)Kr(t[r]),e.__children.push(t[r])}function mt(s){if(s&&s.length){const e=s[0].parentNode;for(let t=0;t<s.length;t++)e.removeChild(s[t])}}function xt(s,e){const t=e.__effectiveBaseUrl;return t?e.constructor.__createUrl(s.replace(/^\//,""),t).pathname:s}function ni(s){return s.map(e=>e.path).reduce((e,t)=>t.length?e.replace(/\/$/,"")+"/"+t.replace(/^\//,""):e,"")}class K extends st{constructor(e,t){const r=document.head.querySelector("base"),i=r&&r.getAttribute("href");super([],Object.assign({baseUrl:i&&st.__createUrl(i,document.URL).pathname.replace(/[^\/]*$/,"")},t)),this.resolveRoute=c=>this.__resolveRoute(c);const o=K.NavigationTrigger;K.setTriggers.apply(K,Object.keys(o).map(c=>o[c])),this.baseUrl,this.ready,this.ready=Promise.resolve(e),this.location,this.location=H({resolver:this}),this.__lastStartedRenderId=0,this.__navigationEventHandler=this.__onNavigationEvent.bind(this),this.setOutlet(e),this.subscribe(),this.__createdByRouter=new WeakMap,this.__addedByRouter=new WeakMap}__resolveRoute(e){const t=e.route;let r=Promise.resolve();ge(t.children)&&(r=r.then(()=>t.children(ko(e))).then(o=>{!es(o)&&!ge(t.children)&&(o=t.children),Ao(o,t)}));const i={redirect:o=>br(e,o),component:o=>{const c=document.createElement(o);return this.__createdByRouter.set(c,!0),c}};return r.then(()=>{if(this.__isLatestRender(e))return _t(t.action,[e,i],t)}).then(o=>{if(es(o)&&(o instanceof HTMLElement||o.redirect||o===Pe))return o;if(G(t.redirect))return i.redirect(t.redirect);if(t.bundle)return Qn(t.bundle).then(()=>{},()=>{throw new Error(Y(`Bundle not found: ${t.bundle}. Check if the file name is correct`))})}).then(o=>{if(es(o))return o;if(G(t.component))return i.component(t.component)})}setOutlet(e){e&&this.__ensureOutlet(e),this.__outlet=e}getOutlet(){return this.__outlet}setRoutes(e,t=!1){return this.__previousContext=void 0,this.__urlForName=void 0,super.setRoutes(e),t||this.__onNavigationEvent(),this.ready}render(e,t){const r=++this.__lastStartedRenderId,i=Object.assign({search:"",hash:""},G(e)?{pathname:e}:e,{__renderId:r});return this.ready=this.resolve(i).then(o=>this.__fullyResolveChain(o)).then(o=>{if(this.__isLatestRender(o)){const c=this.__previousContext;if(o===c)return this.__updateBrowserHistory(c,!0),this.location;if(this.location=H(o),t&&this.__updateBrowserHistory(o,r===1),Ke("location-changed",{router:this,location:this.location}),o.__skipAttach)return this.__copyUnchangedElements(o,c),this.__previousContext=o,this.location;this.__addAppearingContent(o,c);const h=this.__animateIfNeeded(o);return this.__runOnAfterEnterCallbacks(o),this.__runOnAfterLeaveCallbacks(o,c),h.then(()=>{if(this.__isLatestRender(o))return this.__removeDisappearingContent(),this.__previousContext=o,this.location})}}).catch(o=>{if(r===this.__lastStartedRenderId)throw t&&this.__updateBrowserHistory(i),mt(this.__outlet&&this.__outlet.children),this.location=H(Object.assign(i,{resolver:this})),Ke("error",Object.assign({router:this,error:o},i)),o}),this.ready}__fullyResolveChain(e,t=e){return this.__findComponentContextAfterAllRedirects(t).then(r=>{const o=r!==t?r:e,h=xt(ni(r.chain),r.resolver)===r.pathname,u=(m,b=m.route,w)=>m.next(void 0,b,w).then(v=>v===null||v===Pe?h?m:b.parent!==null?u(m,b.parent,v):v:v);return u(r).then(m=>{if(m===null||m===Pe)throw Jr(o);return m&&m!==Pe&&m!==r?this.__fullyResolveChain(o,m):this.__amendWithOnBeforeCallbacks(r)})})}__findComponentContextAfterAllRedirects(e){const t=e.result;return t instanceof HTMLElement?(So(e,t),Promise.resolve(e)):t.redirect?this.__redirect(t.redirect,e.__redirectCount,e.__renderId).then(r=>this.__findComponentContextAfterAllRedirects(r)):t instanceof Error?Promise.reject(t):Promise.reject(new Error(Y(`Invalid route resolution result for path "${e.pathname}". Expected redirect object or HTML element, but got: "${Xn(t)}". Double check the action return value for the route.`)))}__amendWithOnBeforeCallbacks(e){return this.__runOnBeforeCallbacks(e).then(t=>t===this.__previousContext||t===e?t:this.__fullyResolveChain(t))}__runOnBeforeCallbacks(e){const t=this.__previousContext||{},r=t.chain||[],i=e.chain;let o=Promise.resolve();const c=()=>({cancel:!0}),h=u=>br(e,u);if(e.__divergedChainIndex=0,e.__skipAttach=!1,r.length){for(let u=0;u<Math.min(r.length,i.length)&&!(r[u].route!==i[u].route||r[u].path!==i[u].path&&r[u].element!==i[u].element||!this.__isReusableElement(r[u].element,i[u].element));u=++e.__divergedChainIndex);if(e.__skipAttach=i.length===r.length&&e.__divergedChainIndex==i.length&&this.__isReusableElement(e.result,t.result),e.__skipAttach){for(let u=i.length-1;u>=0;u--)o=this.__runOnBeforeLeaveCallbacks(o,e,{prevent:c},r[u]);for(let u=0;u<i.length;u++)o=this.__runOnBeforeEnterCallbacks(o,e,{prevent:c,redirect:h},i[u]),r[u].element.location=H(e,r[u].route)}else for(let u=r.length-1;u>=e.__divergedChainIndex;u--)o=this.__runOnBeforeLeaveCallbacks(o,e,{prevent:c},r[u])}if(!e.__skipAttach)for(let u=0;u<i.length;u++)u<e.__divergedChainIndex?u<r.length&&r[u].element&&(r[u].element.location=H(e,r[u].route)):(o=this.__runOnBeforeEnterCallbacks(o,e,{prevent:c,redirect:h},i[u]),i[u].element&&(i[u].element.location=H(e,i[u].route)));return o.then(u=>{if(u){if(u.cancel)return this.__previousContext.__renderId=e.__renderId,this.__previousContext;if(u.redirect)return this.__redirect(u.redirect,e.__redirectCount,e.__renderId)}return e})}__runOnBeforeLeaveCallbacks(e,t,r,i){const o=H(t);return e.then(c=>{if(this.__isLatestRender(t))return yr("onBeforeLeave",[o,r,this],i.element)(c)}).then(c=>{if(!(c||{}).redirect)return c})}__runOnBeforeEnterCallbacks(e,t,r,i){const o=H(t,i.route);return e.then(c=>{if(this.__isLatestRender(t))return yr("onBeforeEnter",[o,r,this],i.element)(c)})}__isReusableElement(e,t){return e&&t?this.__createdByRouter.get(e)&&this.__createdByRouter.get(t)?e.localName===t.localName:e===t:!1}__isLatestRender(e){return e.__renderId===this.__lastStartedRenderId}__redirect(e,t,r){if(t>$o)throw new Error(Y(`Too many redirects when rendering ${e.from}`));return this.resolve({pathname:this.urlForPath(e.pathname,e.params),redirectFrom:e.from,__redirectCount:(t||0)+1,__renderId:r})}__ensureOutlet(e=this.__outlet){if(!(e instanceof Node))throw new TypeError(Y(`Expected router outlet to be a valid DOM Node (but got ${e})`))}__updateBrowserHistory({pathname:e,search:t="",hash:r=""},i){if(window.location.pathname!==e||window.location.search!==t||window.location.hash!==r){const o=i?"replaceState":"pushState";window.history[o](null,document.title,e+t+r),window.dispatchEvent(new PopStateEvent("popstate",{state:"vaadin-router-ignore"}))}}__copyUnchangedElements(e,t){let r=this.__outlet;for(let i=0;i<e.__divergedChainIndex;i++){const o=t&&t.chain[i].element;if(o)if(o.parentNode===r)e.chain[i].element=o,r=o;else break}return r}__addAppearingContent(e,t){this.__ensureOutlet(),this.__removeAppearingContent();const r=this.__copyUnchangedElements(e,t);this.__appearingContent=[],this.__disappearingContent=Array.from(r.children).filter(o=>this.__addedByRouter.get(o)&&o!==e.result);let i=r;for(let o=e.__divergedChainIndex;o<e.chain.length;o++){const c=e.chain[o].element;c&&(i.appendChild(c),this.__addedByRouter.set(c,!0),i===r&&this.__appearingContent.push(c),i=c)}}__removeDisappearingContent(){this.__disappearingContent&&mt(this.__disappearingContent),this.__disappearingContent=null,this.__appearingContent=null}__removeAppearingContent(){this.__disappearingContent&&this.__appearingContent&&(mt(this.__appearingContent),this.__disappearingContent=null,this.__appearingContent=null)}__runOnAfterLeaveCallbacks(e,t){if(t)for(let r=t.chain.length-1;r>=e.__divergedChainIndex&&this.__isLatestRender(e);r--){const i=t.chain[r].element;if(i)try{const o=H(e);_t(i.onAfterLeave,[o,{},t.resolver],i)}finally{this.__disappearingContent.indexOf(i)>-1&&mt(i.children)}}}__runOnAfterEnterCallbacks(e){for(let t=e.__divergedChainIndex;t<e.chain.length&&this.__isLatestRender(e);t++){const r=e.chain[t].element||{},i=H(e,e.chain[t].route);_t(r.onAfterEnter,[i,{},e.resolver],r)}}__animateIfNeeded(e){const t=(this.__disappearingContent||[])[0],r=(this.__appearingContent||[])[0],i=[],o=e.chain;let c;for(let h=o.length;h>0;h--)if(o[h-1].route.animate){c=o[h-1].route.animate;break}if(t&&r&&c){const h=Ut(c)&&c.leave||"leaving",u=Ut(c)&&c.enter||"entering";i.push(gr(t,h)),i.push(gr(r,u))}return Promise.all(i).then(()=>e)}subscribe(){window.addEventListener("vaadin-router-go",this.__navigationEventHandler)}unsubscribe(){window.removeEventListener("vaadin-router-go",this.__navigationEventHandler)}__onNavigationEvent(e){const{pathname:t,search:r,hash:i}=e?e.detail:window.location;G(this.__normalizePathname(t))&&(e&&e.preventDefault&&e.preventDefault(),this.render({pathname:t,search:r,hash:i},!0))}static setTriggers(...e){_o(e)}urlForName(e,t){return this.__urlForName||(this.__urlForName=vo(this)),xt(this.__urlForName(e,t),this)}urlForPath(e,t){return xt(K.pathToRegexp.compile(e)(t),this)}static go(e){const{pathname:t,search:r,hash:i}=G(e)?this.__createUrl(e,"http://a"):e;return Ke("go",{pathname:t,search:r,hash:i})}}const To=/\/\*[\*!]\s+vaadin-dev-mode:start([\s\S]*)vaadin-dev-mode:end\s+\*\*\//i,Et=window.Vaadin&&window.Vaadin.Flow&&window.Vaadin.Flow.clients;function Po(){function s(){return!0}return oi(s)}function Co(){try{return Ro()?!0:Oo()?Et?!Uo():!Po():!1}catch{return!1}}function Ro(){return localStorage.getItem("vaadin.developmentmode.force")}function Oo(){return["localhost","127.0.0.1"].indexOf(window.location.hostname)>=0}function Uo(){return!!(Et&&Object.keys(Et).map(e=>Et[e]).filter(e=>e.productionMode).length>0)}function oi(s,e){if(typeof s!="function")return;const t=To.exec(s.toString());if(t)try{s=new Function(t[1])}catch(r){console.log("vaadin-development-mode-detector: uncommentAndRun() failed",r)}return s(e)}window.Vaadin=window.Vaadin||{};const wr=function(s,e){if(window.Vaadin.developmentMode)return oi(s,e)};window.Vaadin.developmentMode===void 0&&(window.Vaadin.developmentMode=Co());function Bo(){}const Io=function(){if(typeof wr=="function")return wr(Bo)};window.Vaadin=window.Vaadin||{};window.Vaadin.registrations=window.Vaadin.registrations||[];window.Vaadin.registrations.push({is:"@vaadin/router",version:"1.7.4"});Io();K.NavigationTrigger={POPSTATE:so,CLICK:eo};var Lo=Object.defineProperty,Do=Object.getOwnPropertyDescriptor,$s=(s,e,t,r)=>{for(var i=r>1?void 0:r?Do(e,t):e,o=s.length-1,c;o>=0;o--)(c=s[o])&&(i=(r?c(e,t,i):c(i))||i);return r&&i&&Lo(e,t,i),i};let rt=class extends S{constructor(s){super(),this.redirectAfterSubmit=!1,this.profile=s}_handleSubmit(s){s.preventDefault();const e=s.target,t=new FormData(e),r={...this.profile,name:t.get("name"),bio:t.get("bio"),musicTaste:t.get("musicTaste"),timezone:t.get("timezone"),spotify:t.get("spotify")==="true"},i=new CustomEvent("profile-update",{detail:{profile:r},bubbles:!0,composed:!0});console.log("profile-update Event being sent to DOM"),this.dispatchEvent(i);const o=new CustomEvent("update-using",{detail:{profile:r},bubbles:!0,composed:!0});console.log("profile update event being sent to profile component to update using"),this.dispatchEvent(o),this.requestUpdate(),this.redirectAfterSubmit&&K.go("/app/home")}render(){var s,e,t,r,i,o;return y`
              ...
              <form @submit=${this._handleSubmit}>
                <div class="form-group">
                  ...
                  <input
                    ...
                    id="timezone"
                    name="timezone"
                    .value=${(r=this.profile)==null?void 0:r.timezone}
    ...
    `}};be.styles=Tn;ct([_()],be.prototype,"path",2);ct([_()],be.prototype,"editMode",2);ct([_()],be.prototype,"profileEditText",2);ct([_({attribute:!1})],be.prototype,"using",2);be=ct([A("user-profile")],be);var Mo=Object.defineProperty,jo=Object.getOwnPropertyDescriptor,ai=(s,e,t,r)=>{for(var i=r>1?void 0:r?jo(e,t):e,o=s.length-1,c;o>=0;o--)(c=s[o])&&(i=(r?c(e,t,i):c(i))||i);return r&&i&&Mo(e,t,i),i};let as=class extends S{constructor(){super(...arguments),this.router=new K(this),this.routes=[]}connectedCallback(){super.connectedCallback(),this.router.setRoutes(this.routes),console.log("Router:",this.routes)}render(){return y`<slot></slot>`}};ai([_({attribute:!1})],as.prototype,"routes",2);as=ai([A("vaadin-router")],as);const qo=P`
  :host {
    display: block;
    margin: auto;
  }
...
`;var ea=Object.defineProperty,ta=Object.getOwnPropertyDescriptor,li=(s,e,t,r)=>{for(var i=r>1?void 0:r?ta(e,t):e,o=s.length-1,c;o>=0;o--)(c=s[o])&&(i=(r?c(e,t,i):c(i))||i);return r&&i&&ea(e,t,i),i};let Bt=class extends S{_handleClick(){console.log("track clicked!"),this.dispatchEvent(new CustomEvent("track-selected",{detail:{track:this.track},bubbles:!0,composed:!0}))}render(){if(!this.track)return y`
...
`;function fa(s,e,t){const r=s.selectedTracks.findIndex(i=>i.id===e.id);t?r>-1?s.selectedTracks=[...s.selectedTracks.slice(0,r),...s.selectedTracks.slice(r+1)]:s.selectedTracks=[...s.selectedTracks,e]:r>-1?s.selectedTracks=[]:s.selectedTracks=[e]}function di(s){s.topTracks=[]}function ui(s){s.selectedTracks=[]}async function ma(s,e){const t=await fetch(`https://api.spotify.com/v1/artists/${e}/top-tracks?market=US`,{method:"GET",headers:{Authorization:`Bearer ${s.accessToken}`,"Content-Type":"application/json"}});if(t.ok){const r=await t.json();r&&r.tracks?s.topTracks=r.tracks:console.log("No tracks found or data is malformed")}else throw new Error(`Error: ${t.statusText}`)}async function pi(s){const r=await fetch("https://accounts.spotify.com/api/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded",Authorization:"Basic "+ks.Buffer.from("7fd3e17624134115b09da726f05a671c:09d164c52b1e43d9bcef963d9f2a8aac").toString("base64")},body:"grant_type=client_credentials"});if(r.ok){const i=await r.json();s.accessToken=i.access_token}else console.error("Spotify authentication failed")}async function fi(s){if(!s.requestedSearchQuery.trim())return;const e=`https://api.spotify.com/v1/search?q=${encodeURIComponent(s.requestedSearchQuery)}&type=track&limit=10`;try{await pi(s);const t=await fetch(e,{method:"GET",headers:{Authorization:`Bearer ${s.accessToken}`,"Content-Type":"application/json"}});if(!t.ok)throw new Error(`Error: ${t.statusText}`);const r=await t.json();r.tracks.items.length>0?s.topTracks=r.tracks.items:(s.topTracks=[],alert("No tracks found. Please try another search."))}catch(t){console.error("Error searching for tracks:",t)}}async function ga(s,e){s.preventDefault();const t=s.target,r=new FormData(t);e.requestedSearchQuery=r.get("inputted-artist-name"),await fi(e)}async function ba(s,e){var m;s.preventDefault(),e.submissionSuccess=null;const t=s.target,r=new FormData(t),i="http://localhost:3000";let o=r.get("input-comment");const c=e.selectedTracks.map(b=>b.id),h=`${i}/posts/${(m=e.post)==null?void 0:m._id}`,u={userName:"aidan",commentTime:new Date,commentMessage:o,SongIDs:c};try{if((await fetch(h,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(u)})).ok)console.log("Comment successfully added"),di(e),ui(e),e.submissionSuccess=!0,t.reset(),e.dispatchEvent(new CustomEvent("handle-comment-added",{bubbles:!0,composed:!0}));else throw new Error("Failed to post comment")}catch(b){console.error("Error:",b),e.submissionSuccess=!1}}const ya=P`
  .search-and-selected {
    display: flex;
    flex-direction: row;
  }
...
`;var wa=Object.defineProperty,va=Object.getOwnPropertyDescriptor,As=(s,e,t,r)=>{for(var i=r>1?void 0:r?va(e,t):e,o=s.length-1,c;o>=0;o--)(c=s[o])&&(i=(r?c(e,t,i):c(i))||i);return r&&i&&wa(e,t,i),i};let it=class extends S{constructor(){super(...arguments),this.topTracks=[],this.selectedTracks=[]}_sendClearTracks(s){console.log("wanting to clear ",s," tracks"),this.dispatchEvent(new CustomEvent("clear-tracks",{detail:{topOrSelected:s},bubbles:!0,composed:!0}))}render(){return y`
    ...
    `}};it.styles=[ya];As([E()],it.prototype,"topTracks",2);As([E()],it.prototype,"selectedTracks",2);it=As([A("multi-song-ui")],it);const _a=P`
  .search-and-selected {
    display: flex;
    flex-direction: column;
  }
...
`;var xa=Object.defineProperty,Ea=Object.getOwnPropertyDescriptor,Ts=(s,e,t,r)=>{for(var i=r>1?void 0:r?Ea(e,t):e,o=s.length-1,c;o>=0;o--)(c=s[o])&&(i=(r?c(e,t,i):c(i))||i);return r&&i&&xa(e,t,i),i};let nt=class extends S{constructor(){super(...arguments),this.topTracks=[],this.selectedTracks=[]}_sendClearTracks(s){console.log("wanting to clear ",s," tracks"),this.dispatchEvent(new CustomEvent("clear-tracks",{detail:{topOrSelected:s},bubbles:!0,composed:!0}))}render(){return y`
    ...
    `}};nt.styles=[_a];Ts([E()],nt.prototype,"topTracks",2);Ts([E()],nt.prototype,"selectedTracks",2);nt=Ts([A("single-song-ui")],nt);var $a=Object.defineProperty,ka=Object.getOwnPropertyDescriptor,J=(s,e,t,r)=>{for(var i=r>1?void 0:r?ka(e,t):e,o=s.length-1,c;o>=0;o--)(c=s[o])&&(i=(r?c(e,t,i):c(i))||i);return r&&i&&$a(e,t,i),i};let j=class extends S{constructor(){super(),this.submissionSuccess=null,this.expandedText="unexpanded",this.requestedSearchQuery="",this.accessToken="",this.topTracks=[],this.selectedTracks=[],this.hasMargin=!1,this.expandedClass="feed-single-post",this.multiPicker=!1,this.addEventListener("track-selected",s=>{const e=s;this._selectTrack(e.detail.track,this.multiPicker)}),this.addEventListener("clear-tracks",s=>{console.log("Within Clear Tracks Listener"),s.detail.topOrSelected==="top"?(console.log("Within Top, executing clear top tracks"),this._clearTopTracks()):(console.log("Within Selected, executing clear selected tracks"),this._clearSelectedTracks())})}async _authenticate(){await pi(this)}async _submitCommentToDatabase(s){await ba(s,this)}_handleSubmit(s){ga(s,this)}_clearTopTracks(){di(this)}_clearSelectedTracks(){ui(this)}_selectTrack(s,e){fa(this,s,e)}async fetchTopTracks(s){await ma(this,s)}async searchSpotify(){await fi(this)}_submitSongRecommendationToGameState(s){s.preventDefault(),console.log("submit song recommendation clicked"),this.selectedTracks.length==1?(console.log("the selected track, ",this.selectedTracks[0]),this.dispatchEvent(new CustomEvent("single-track-submitted",{detail:{track:this.selectedTracks[0]},bubbles:!0,composed:!0}))):console.log("no track selected, cannot submit form")}render(){return y`
      <section
    ...
    `}};z.styles=Qo;se([_({type:Object})],z.prototype,"post",2);se([E()],z.prototype,"getPostComments",2);se([E()],z.prototype,"expanded",2);se([E()],z.prototype,"commentsSectionExpanded",2);se([E()],z.prototype,"submissionSuccess",2);se([_()],z.prototype,"expandedText",2);se([_({type:String})],z.prototype,"requestedSearchQuery",2);se([_({type:String})],z.prototype,"accessToken",2);se([E()],z.prototype,"expandedClass",2);z=se([A("feed-post")],z);var Pa=Object.defineProperty,Ca=Object.getOwnPropertyDescriptor,mi=(s,e,t,r)=>{for(var i=r>1?void 0:r?Ca(e,t):e,o=s.length-1,c;o>=0;o--)(c=s[o])&&(i=(r?c(e,t,i):c(i))||i);return r&&i&&Pa(e,t,i),i};let It=class extends S{constructor(){super(...arguments),this.posts=[]}render(){return y`
      <div class="posts-container">
        ${this.posts.map(s=>y` <feed-post .hasMargin=${!0} .post=${s}></feed-post>`)}
      </div>
...
`;var Oa=Object.defineProperty,Ua=Object.getOwnPropertyDescriptor,ht=(s,e,t,r)=>{for(var i=r>1?void 0:r?Ua(e,t):e,o=s.length-1,c;o>=0;o--)(c=s[o])&&(i=(r?c(e,t,i):c(i))||i);return r&&i&&Oa(e,t,i),i};let we=class extends S{constructor(){super(...arguments),this.expanded=!1,this.submissionSuccess=!1,this.errorMessage=!1}_togglePost(){this.expanded=!this.expanded,this.submissionSuccess=!1,this.errorMessage=!1}async _submitPost(s){s.preventDefault(),this.submissionSuccess=!1;const e=s.target;let r=new FormData(e).get("input-message");r?(console.log("submitting post!"),this._sendPostRequest(r,e)):(console.log("error with message!"),this.errorMessage=!0)}async _sendPostRequest(s,e){if(console.log("this.using",this.using),!this.using||!this.using._id||!this.using.name||!this.using.profileDescription||!this.using.profileImage)return console.error("User information is incomplete."),!1;const t={userid:this.using._id,userName:this.using.name,profileImage:this.using.profileImage,profileDescription:this.using.profileDescription,postTime:new Date,postMessage:s,comments:[]};console.log("new post: ",t);try{if((await fetch("http://localhost:3000/posts",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).ok)console.log("Post added successfully!"),this.submissionSuccess=!0,setTimeout(()=>{this.submissionSuccess=!1},2500),this.expanded=!this.expanded,e.reset(),this._sendUpdateToRefreshMainFeed();else throw new Error("Failed to create post.")}catch(r){console.error("Error: ",r),this.submissionSuccess=!1}}_sendUpdateToRefreshMainFeed(){const s=new CustomEvent("post-created",{bubbles:!0,composed:!0});console.log("dispatching event: ",s),this.dispatchEvent(s)}render(){return y`
      ${this.expanded?y`
