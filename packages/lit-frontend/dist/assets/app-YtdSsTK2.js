 ...
 */function _r({context:r,subscribe:e}){return(t,i)=>{typeof i=="object"?i.addInitializer(function(){new Je(this,{context:r,callback:s=>{this[i.name]=s},subscribe:e})}):t.constructor.addInitializer(s=>{new Je(s,{context:r,callback:n=>{s[i]=n},subscribe:e})})}}let mr=class extends y{constructor(e,t){super(),this.model=t,this.updateFn=e,this.addEventListener("mvu:message",i=>{const s=i.detail;console.log("Got message: ",s),this.receive(s)})}receive(e){if(this.model){const t=this.updateFn(this.model,e),i=t;typeof(i==null?void 0:i.then)=="function"?i.then(s=>{const n=s(this.model);this.model=n}):this.model=t}}},vr=class extends y{dispatchMessage(e,t=this){const i=new CustomEvent("mvu:message",{bubbles:!0,composed:!0,detail:e});t.dispatchEvent(i)}};class br{constructor(){this._handlers=new Map,this.update=this._update.bind(this)}addMessage(e,t){console.log("Message added for dispatch:",e),this._handlers.set(e,t)}_update(e,t){const{type:i}=t,s=this._handlers.get(i);return s?s(t,e):e}}function yr(r){return e=>Object.assign({},e,r)}function $r(r){return r}const wr="http://localhost:3000",Er="/api",we="JWT_AUTH_TOKEN",E=class E{constructor(){this.authenticated=!1,this.username="fellow_traveler",this.signOut=()=>{}}static deauthenticate(e){const t=new E;return console.log("Deauthenticating",e,E._theUser),e===E._theUser&&(localStorage.removeItem(we),E._theUser=t),t}};E._theUser=new E;let b=E;class J extends b{constructor(e,t){super();const s=e.split(".")[1].replace(/-/g,"+").replace(/_/g,"/"),n=decodeURIComponent(window.atob(s).split("").map(function(c){return"%"+("00"+c.charCodeAt(0).toString(16)).slice(-2)}).join("")),o=JSON.parse(n);console.log("Token payload",o),this.token=e,this.authenticated=!0,this.username=o.username,this.signOut=t}static authenticate(e,t){return b._theUser=new J(e,t),localStorage.setItem(we,e),b._theUser}static authenticateFromLocalStorage(e){const t=localStorage.getItem(we);return t?J.authenticate(t,e):b._theUser}}class Te{constructor(e){this._base=Er,this.json=e}base(e=""){return this._base=e,this}get(e){return fetch(this._url(e),{headers:this._headers(),body:this.json&&JSON.stringify(this.json)})}post(e){return fetch(this._url(e),{method:"POST",headers:this._headers(),body:this.json&&JSON.stringify(this.json)})}put(e){return fetch(this._url(e),{method:"PUT",headers:this._headers(),body:this.json&&JSON.stringify(this.json)})}_headers(){const e=this.json!==void 0,t=b._theUser.authenticated,i={"Content-Type":"application/json"};if(t){const n={Authorization:`Bearer ${b._theUser.token}`};return e?{...i,...n}:n}else return e?{...i}:void 0}_url(e){return`${wr}${this._base}${e}`}}class Xe extends Te{constructor(e){super(Object.fromEntries(e))}}class Ar extends Te{constructor(){super(void 0)}}var Pr=Object.defineProperty,Sr=Object.getOwnPropertyDescriptor,wt=(r,e,t,i)=>{for(var s=i>1?void 0:i?Sr(e,t):e,n=r.length-1,o;n>=0;n--)(o=r[n])&&(s=(i?o(e,t,s):o(s))||s);return i&&s&&Pr(e,t,s),s};const Et="BlazingModel",Ee={user:new b},Or=()=>new br,At=yr,Pt=$r;class St extends mr{constructor(e){super(e,Ee),this.model=Ee}}wt([$t({context:Et}),fe()],St.prototype,"model",2);class Me extends vr{getFromModel(e){if(console.log("GET FROM MODEL CALLED"),console.log("dlakjflda",Ee),this._model)return console.log("MODEL PROFILE IN APP.TS: ",this._model.profile),this._model[e]}}wt([_r({context:Et,subscribe:!0}),v({attribute:!1})],Me.prototype,"_model",2);const Le=Or(),Rr=Le.update;Le.addMessage("ProfileSelected",r=>{const{userid:e}=r;return new Ar().get(`/profiles/${e}`).then(t=>{if(t.status===200)return t.json()}).then(t=>{if(t)return console.log("Profile:",t),t}).then(t=>t?At({profile:t}):Pt)});Le.addMessage("ProfileSaved",r=>{const{userid:e,profile:t}=r;return new Te(t).put(`/profiles/${e}`).then(i=>{if(i.status===200)return i.json()}).then(i=>{i&&console.log("Profile:",i)}).then(i=>i?At({profile:i}):Pt)});var Cr=Object.defineProperty,xr=Object.getOwnPropertyDescriptor,Y=(r,e,t,i)=>{for(var s=i>1?void 0:i?xr(e,t):e,n=r.length-1,o;n>=0;n--)(o=r[n])&&(s=(i?o(e,t,s):o(s))||s);return i&&s&&Cr(e,t,s),s};let T=class extends y{constructor(){super(...arguments),this.path=""}get profile(){return this.using||{}}render(){const{name:r,profileImage:e,profileDescription:t,bio:i}=this.profile;return $`
  ...
  `;ge([fe()],H.prototype,"loginStatus",2);ge([fe()],H.prototype,"registerStatus",2);ge([$t({context:bi}),fe()],H.prototype,"user",2);H=ge([O("auth-required")],H);var yi=Object.defineProperty,$i=Object.getOwnPropertyDescriptor,Z=(r,e,t,i)=>{for(var s=i>1?void 0:i?$i(e,t):e,n=r.length-1,o;n>=0;n--)(o=r[n])&&(s=(i?o(e,t,s):o(s))||s);return i&&s&&yi(e,t,s),s};let L=class extends Me{get userid(){var r;return console.log(),(r=this.location)==null?void 0:r.params.userid}get edit(){var r;return(r=this.location)==null?void 0:r.params.edit}get profile(){return this.getFromModel("profile")}attributeChangedCallback(r,e,t){r==="userid"&&e!==t&&t&&(console.log("Profile Page:",t),this.dispatchMessage({type:"ProfileSelected",userid:t})),super.attributeChangedCallback(r,e,t)}render(){return $`
        <user-profile .using=${this.profile}> </user-profile>
    `}};L.styles=[X`
      :host {
        display: contents;
      }
    `];Z([v({attribute:!1})],L.prototype,"location",2);Z([v({reflect:!0})],L.prototype,"userid",1);Z([v({reflect:!0})],L.prototype,"edit",1);Z([v()],L.prototype,"profile",1);L=Z([O("profile-page")],L);var wi=Object.defineProperty,Ei=Object.getOwnPropertyDescriptor,Bt=(r,e,t,i)=>{for(var s=i>1?void 0:i?Ei(e,t):e,n=r.length-1,o;n>=0;n--)(o=r[n])&&(s=(i?o(e,t,s):o(s))||s);return i&&s&&wi(e,t,s),s};let Oe=class extends Me{constructor(){super(...arguments),this.title=""}render(){return $` <p>hi</p> `}};Bt([v()],Oe.prototype,"title",2);Oe=Bt([O("home-page")],Oe);var Ai=Object.defineProperty,Pi=Object.getOwnPropertyDescriptor,Si=(r,e,t,i)=>{for(var s=i>1?void 0:i?Pi(e,t):e,n=r.length-1,o;n>=0;n--)(o=r[n])&&(s=(i?o(e,t,s):o(s))||s);return i&&s&&Ai(e,t,s),s};let Re=class extends y{render(){return $`<h1>This is a Test Page</h1>`}};Re.styles=X`
    h1 {
      color: blue;
    }
  `;Re=Si([O("test-page")],Re);var Oi=Object.defineProperty,Ri=Object.getOwnPropertyDescriptor,Ci=(r,e,t,i)=>{for(var s=i>1?void 0:i?Ri(e,t):e,n=r.length-1,o;n>=0;n--)(o=r[n])&&(s=(i?o(e,t,s):o(s))||s);return i&&s&&Oi(e,t,s),s};let xi=[{path:"/app/profile/:userid/:edit(edit)",component:"profile-page"},{path:"/app/profile/:userid",component:"profile-page"},{path:"/app/",component:"home-page"},{path:"(.*)",component:"not-found-component"}],dt=class extends St{constructor(){super(Rr)}render(){return $`
      <auth-required>
