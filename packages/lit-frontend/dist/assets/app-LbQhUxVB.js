...
`;var On=Object.defineProperty,Rn=Object.getOwnPropertyDescriptor,ct=(r,e,t,s)=>{for(var i=s>1?void 0:s?Rn(e,t):e,a=r.length-1,c;a>=0;a--)(c=r[a])&&(i=(s?c(e,t,i):c(i))||i);return s&&i&&On(e,t,i),i};let fe=class extends A{constructor(){super(),this.names=[],this.namesOriginalOrder=[],this.listAttributes=[],this.sort_state="unsorted",this.initializedNamesOriginalOrder=!1,this.names=[],this.namesOriginalOrder=[...this.names],this.listAttributes=[]}_onStateChanged(r){const e=r.target;this.initializedNamesOriginalOrder||(this.namesOriginalOrder=[...this.names],this.initializedNamesOriginalOrder=!0),this.sort_state=="unsorted"?this.names.sort((t,s)=>{const i=t[0].toUpperCase(),a=s[0].toUpperCase();return i<a?-1:i>a?1:0}):this.sort_state=="sorted"&&(this.names=[...this.namesOriginalOrder]),this.sort_state=e.filteredState}render(){return w`
    ...
    `}};fe.styles=[Cn];ct([v({type:Array})],fe.prototype,"names",2);ct([v({type:Array})],fe.prototype,"namesOriginalOrder",2);ct([v({type:Array})],fe.prototype,"listAttributes",2);ct([k()],fe.prototype,"sort_state",2);fe=ct([S("sortable-list")],fe);const Bn=P`
  svg {
    height: 1.4em;
    width: 1.4em;
  }
...
`;var Un=Object.defineProperty,In=Object.getOwnPropertyDescriptor,Nt=(r,e,t,s)=>{for(var i=s>1?void 0:s?In(e,t):e,a=r.length-1,c;a>=0;a--)(c=r[a])&&(i=(s?c(e,t,i):c(i))||i);return s&&i&&Un(e,t,i),i};let Oe=class extends A{constructor(){super(),this.names=[],this.listAttributes=[],this.sort_state="unsorted",this.names=[],this.listAttributes=[]}render(){return w`
    ...
    `}};Oe.styles=[Bn];Nt([v({type:Array})],Oe.prototype,"names",2);Nt([v({type:Array})],Oe.prototype,"listAttributes",2);Nt([k()],Oe.prototype,"sort_state",2);Oe=Nt([S("general-list")],Oe);const Dn=P`
...
`;var Ln=Object.defineProperty,Fn=Object.getOwnPropertyDescriptor,vr=(r,e,t,s)=>{for(var i=s>1?void 0:s?Fn(e,t):e,a=r.length-1,c;a>=0;a--)(c=r[a])&&(i=(s?c(e,t,i):c(i))||i);return s&&i&&Ln(e,t,i),i};let et=class extends A{constructor(){super(...arguments),this.artists=[],this.listAttributes=""}render(){return w`
    ...
    `}};et.styles=[Dn];vr([v({type:Array})],et.prototype,"artists",2);vr([v({type:String})],et.prototype,"listAttributes",2);et=vr([S("favorites-list")],et);const Nn=P`
  :host {
...
`;var zn=Object.defineProperty,Hn=Object.getOwnPropertyDescriptor,Ys=(r,e,t,s)=>{for(var i=s>1?void 0:s?Hn(e,t):e,a=r.length-1,c;a>=0;a--)(c=r[a])&&(i=(s?c(e,t,i):c(i))||i);return s&&i&&zn(e,t,i),i};let Ct=class extends A{constructor(){super(...arguments),this.on=!1}render(){return w`<label>
      <slot>Light Mode</slot>
      <span class="slider">
        <input type="checkbox" @change=${this._handleChange} />
      </span>
    </label>`}_handleChange(r){const e=r.target,t=new Event(r.type,{bubbles:!0,composed:!0});document.body.classList.contains("dark-mode")?(document.body.classList.remove("dark-mode"),document.body.classList.add("light-mode")):(document.body.classList.remove("light-mode"),document.body.classList.add("dark-mode")),this.on=e==null?void 0:e.checked,this.dispatchEvent(t)}};Ct.styles=[qn];Ys([v({reflect:!0,type:Boolean})],Ct.prototype,"on",2);Ct=Ys([S("color-mode-switch")],Ct);const Vn=P`
  .user-friend {
    border: 1.5px solid var(--section-border-color);
    width: 120px;
    height: 120px;
...
`;var Wn=Object.defineProperty,Kn=Object.getOwnPropertyDescriptor,Mt=(r,e,t,s)=>{for(var i=s>1?void 0:s?Kn(e,t):e,a=r.length-1,c;a>=0;a--)(c=r[a])&&(i=(s?c(e,t,i):c(i))||i);return s&&i&&Wn(e,t,i),i};let Re=class extends A{constructor(){super(),this.title="",this.description="",this.user_id=0,this.title="",this.description=""}render(){return w`<div class="user-friend">
    ...
    </div> `}};Re.styles=[Vn];Mt([v()],Re.prototype,"title",2);Mt([v()],Re.prototype,"description",2);Mt([v()],Re.prototype,"user_id",2);Re=Mt([S("default-card")],Re);const Yn=P`
  :host {
    display: block;
    padding: 0.5em 0.5em 0.5em 0em;
  }
...
`;var Gn=Object.defineProperty,Jn=Object.getOwnPropertyDescriptor,xr=(r,e,t,s)=>{for(var i=s>1?void 0:s?Jn(e,t):e,a=r.length-1,c;a>=0;a--)(c=r[a])&&(i=(s?c(e,t,i):c(i))||i);return s&&i&&Gn(e,t,i),i};let tt=class extends A{constructor(){super(...arguments),this.on=!1,this.filteredState=""}render(){return w`<label>
      <slot class="label-title">sort alphabetically by name</slot>
      <span class="slider">
        <input type="checkbox" @change=${this._onInput} />
      </span>
    </label>`}_onInput(){this.filteredState=="unsorted"?this.filteredState="sorted":this.filteredState="unsorted",this.dispatchEvent(new Event("state-changed"))}};tt.styles=[Yn];xr([v({reflect:!0,type:Boolean})],tt.prototype,"on",2);xr([v()],tt.prototype,"filteredState",2);tt=xr([S("toggle-switch")],tt);const Xn=P`
...
`;var Ko=Object.defineProperty,Yo=Object.getOwnPropertyDescriptor,jt=(r,e,t,s)=>{for(var i=s>1?void 0:s?Yo(e,t):e,a=r.length-1,c;a>=0;a--)(c=r[a])&&(i=(s?c(e,t,i):c(i))||i);return s&&i&&Ko(e,t,i),i};let Be=class extends A{constructor(){super(...arguments),this.loading=!0,this.user=new H}render(){return w`
    ...
    `];ht([v({attribute:!1})],ye.prototype,"location",2);ht([v({reflect:!0})],ye.prototype,"userid",1);ht([v({reflect:!0})],ye.prototype,"edit",1);ht([v()],ye.prototype,"profile",1);ye=ht([S("profile-page")],ye);const Xo=P`
  .feed-container {
    width: 50em;
    margin-top: 3em;
  }
...
`;var da=Object.defineProperty,pa=Object.getOwnPropertyDescriptor,zt=(r,e,t,s)=>{for(var i=s>1?void 0:s?pa(e,t):e,a=r.length-1,c;a>=0;a--)(c=r[a])&&(i=(s?c(e,t,i):c(i))||i);return s&&i&&da(e,t,i),i};let Ue=class extends A{constructor(){super(...arguments),this.accessToken="",this.currentTracks=[]}async findSong(r){const e=`https://api.spotify.com/v1/tracks/${r}`;try{await this.authenticate();const t=await fetch(e,{method:"GET",headers:{Authorization:`Bearer ${this.accessToken}`,"Content-Type":"application/json"}});if(!t.ok)throw new Error(`Error: ${t.statusText}`);const s=await t.json();return this.currentTracks=[...this.currentTracks,s],s}catch(t){return console.error("Error searching for track:",t),null}}async authenticate(){const t=await fetch("https://accounts.spotify.com/api/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded",Authorization:"Basic "+kr.Buffer.from("7fd3e17624134115b09da726f05a671c:09d164c52b1e43d9bcef963d9f2a8aac").toString("base64")},body:"grant_type=client_credentials"});if(t.ok){const s=await t.json();this.accessToken=s.access_token}else console.error("Spotify authentication failed")}async connectedCallback(){var r;super.connectedCallback(),(r=this.comment)!=null&&r.SongIDs&&await this.fetchAllTracks(this.comment.SongIDs)}async fetchAllTracks(r){try{this.currentTracks=[];const e=r.map(s=>this.findSong(s)),t=await Promise.all(e);this.currentTracks=t.filter(s=>s!==null),this.requestUpdate()}catch(e){console.error("Error fetching tracks:",e)}}render(){if(!this.comment)return w`
    ...
    `}};Ue.styles=[ua];zt([v({type:Object})],Ue.prototype,"comment",2);zt([v({type:String})],Ue.prototype,"accessToken",2);zt([k()],Ue.prototype,"currentTracks",2);Ue=zt([S("comment-card")],Ue);const fa=P`
  /* Search Form */
...
`;var _a=Object.defineProperty,va=Object.getOwnPropertyDescriptor,Sr=(r,e,t,s)=>{for(var i=s>1?void 0:s?va(e,t):e,a=r.length-1,c;a>=0;a--)(c=r[a])&&(i=(s?c(e,t,i):c(i))||i);return s&&i&&_a(e,t,i),i};let it=class extends A{constructor(){super(...arguments),this.topTracks=[],this.selectedTracks=[]}_sendClearTracks(r){console.log("wanting to clear ",r," tracks"),this.dispatchEvent(new CustomEvent("clear-tracks",{detail:{topOrSelected:r},bubbles:!0,composed:!0}))}render(){return w`
    ...
    `}};it.styles=[wa];Sr([k()],it.prototype,"topTracks",2);Sr([k()],it.prototype,"selectedTracks",2);it=Sr([S("multi-song-ui")],it);const xa=P`
  .search-and-selected {
    display: flex;
    flex-direction: column;
  }
...
`;var Ea=Object.defineProperty,$a=Object.getOwnPropertyDescriptor,Tr=(r,e,t,s)=>{for(var i=s>1?void 0:s?$a(e,t):e,a=r.length-1,c;a>=0;a--)(c=r[a])&&(i=(s?c(e,t,i):c(i))||i);return s&&i&&Ea(e,t,i),i};let nt=class extends A{constructor(){super(...arguments),this.topTracks=[],this.selectedTracks=[]}_sendClearTracks(r){console.log("wanting to clear ",r," tracks"),this.dispatchEvent(new CustomEvent("clear-tracks",{detail:{topOrSelected:r},bubbles:!0,composed:!0}))}render(){return w`
    ...
    `}};K.styles=Zo;re([v({type:Object})],K.prototype,"post",2);re([k()],K.prototype,"getPostComments",2);re([k()],K.prototype,"expanded",2);re([k()],K.prototype,"submissionSuccess",2);re([v()],K.prototype,"expandedText",2);re([v({type:String})],K.prototype,"requestedSearchQuery",2);re([v({type:String})],K.prototype,"accessToken",2);re([k()],K.prototype,"expandedClass",2);K=re([S("feed-post")],K);var Ca=Object.defineProperty,Oa=Object.getOwnPropertyDescriptor,mi=(r,e,t,s)=>{for(var i=s>1?void 0:s?Oa(e,t):e,a=r.length-1,c;a>=0;a--)(c=r[a])&&(i=(s?c(e,t,i):c(i))||i);return s&&i&&Ca(e,t,i),i};let Dt=class extends A{constructor(){super(...arguments),this.posts=[]}render(){return w`
      <div class="posts-container">
        ${this.posts.map(r=>w` <feed-post .hasMargin=${!0} .post=${r}></feed-post>`)}
      </div>
    `}};Dt.styles=[Qo];mi([v({type:Array})],Dt.prototype,"posts",2);Dt=mi([S("feed-post-list")],Dt);const Ra=P`
  :host {
    display: block;
  }
...
`;var Ba=Object.defineProperty,Ua=Object.getOwnPropertyDescriptor,Ht=(r,e,t,s)=>{for(var i=s>1?void 0:s?Ua(e,t):e,a=r.length-1,c;a>=0;a--)(c=r[a])&&(i=(s?c(e,t,i):c(i))||i);return s&&i&&Ba(e,t,i),i};let Ie=class extends A{constructor(){super(...arguments),this.expanded=!1,this.submissionSuccess=!1,this.errorMessage=!1}_togglePost(){this.expanded=!this.expanded,this.submissionSuccess=!1,this.errorMessage=!1}async _submitPost(r){r.preventDefault(),this.submissionSuccess=!1;const e=r.target;let s=new FormData(e).get("input-message");s?(console.log("submitting post!"),this._sendPostRequest(s,e)):(console.log("error with message!"),this.errorMessage=!0)}async _sendPostRequest(r,e){const t={userid:"65caf83fcdc541534288d60b",userName:"aidan",postTime:new Date,postMessage:r,comments:[]},s="http://localhost:3000";console.log("new post: ",t);try{const i=`${s}/posts`;if((await fetch(i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).ok)console.log("Post added successfully!"),this.submissionSuccess=!0,this.expanded=!this.expanded,e.reset(),this._sendUpdateToRefreshMainFeed();else throw new Error("Failed to create post.")}catch(i){console.error("Error: ",i),this.submissionSuccess=!1}}_sendUpdateToRefreshMainFeed(){const r=new CustomEvent("post-created",{bubbles:!0,composed:!0});console.log("dispatching event: ",r),this.dispatchEvent(r)}render(){return w`
  ...
  `;ut([v({attribute:!1})],be.prototype,"location",2);ut([v({reflect:!0})],be.prototype,"userid",1);ut([v({reflect:!0})],be.prototype,"edit",1);ut([v()],be.prototype,"profile",1);be=ut([S("home-page")],be);const Na=P`
  :host {
    display: block;
...
`;var Ma=Object.defineProperty,ja=Object.getOwnPropertyDescriptor,Pr=(r,e,t,s)=>{for(var i=s>1?void 0:s?ja(e,t):e,a=r.length-1,c;a>=0;a--)(c=r[a])&&(i=(s?c(e,t,i):c(i))||i);return s&&i&&Ma(e,t,i),i};let ot=class extends Le{constructor(){super(...arguments),this.profile=null,this.loading=!0}navigateTo(r){W.go(r)}async firstUpdated(){console.log("******** NOT FOUND PAGE FIRST UPDATE ********"),await this.fetchProfile()}async fetchProfile(){try{const r=await this.getFromModel("profile");console.log("Profile fetched:",r),r?this.profile=r:this.profile=null}catch(r){console.error("Failed to fetch profile:",r),this.profile=null}finally{this.loading=!1,console.log("Profile fetched and set:",this.profile)}}render(){return console.log("within not found page this.profile ",this.profile),w`
    ...
    `}};ot.styles=[Na];Pr([k()],ot.prototype,"profile",2);Pr([k()],ot.prototype,"loading",2);ot=Pr([S("not-found-page")],ot);const qa=P`
  .page-content {
    display: flex;
    justify-content: center;
    width: 70%;
...
`;var za=Object.defineProperty,Ha=Object.getOwnPropertyDescriptor,dt=(r,e,t,s)=>{for(var i=s>1?void 0:s?Ha(e,t):e,a=r.length-1,c;a>=0;a--)(c=r[a])&&(i=(s?c(e,t,i):c(i))||i);return s&&i&&za(e,t,i),i};let we=class extends Le{get userid(){var r;return console.log(),(r=this.location)==null?void 0:r.params.userid}get edit(){var r;return(r=this.location)==null?void 0:r.params.edit}get profile(){return this.getFromModel("profile")}attributeChangedCallback(r,e,t){r==="userid"&&e!==t&&t&&(console.log("Profile Page:",t),this.dispatchMessage({type:"ProfileSelected",userid:t})),super.attributeChangedCallback(r,e,t)}connectedCallback(){super.connectedCallback(),this.addEventListener("profile-update",r=>this._handleProfileUpdate(r))}_handleProfileUpdate(r){console.log("Profile updated",r.detail.profile);const e=this.userid;e?this.dispatchMessage({type:"ProfileSaved",userid:e,profile:r.detail.profile}):console.error("UserID is undefined.")}render(){return w`
    ...
    `}};we.styles=qa;dt([v({attribute:!1})],we.prototype,"location",2);dt([v({reflect:!0})],we.prototype,"userid",1);dt([v({reflect:!0})],we.prototype,"edit",1);dt([v()],we.prototype,"profile",1);we=dt([S("create-profile-page")],we);const Va=P`
  :host {
    display: block;
  }
  .gameFeature {
