 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const O=i=>(e,t)=>{t!==void 0?t.addInitializer(()=>{customElements.define(i,e)}):customElements.define(i,e)};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */function Or({context:i,subscribe:e}){return(t,o)=>{typeof o=="object"?o.addInitializer(function(){new rr(this,{context:i,callback:s=>{this[o.name]=s},subscribe:e})}):t.constructor.addInitializer(s=>{new rr(s,{context:i,callback:a=>{s[o]=a},subscribe:e})})}}let qi=class extends S{constructor(e,t){super(),this.model=t,this.updateFn=e,this.addEventListener("mvu:message",o=>{const s=o.detail;console.log("Got message: ",s),this.receive(s)})}receive(e){if(this.model){const t=this.updateFn(this.model,e),o=t;typeof(o==null?void 0:o.then)=="function"?o.then(s=>{const a=s(this.model);this.model=a}):this.model=t}}},Vi=class extends S{dispatchMessage(e,t=this){const o=new CustomEvent("mvu:message",{bubbles:!0,composed:!0,detail:e});t.dispatchEvent(o)}};class Wi{constructor(){this._handlers=new Map,this.update=this._update.bind(this)}addMessage(e,t){console.log("Message added for dispatch:",e),this._handlers.set(e,t)}_update(e,t){const{type:o}=t,s=this._handlers.get(o);return s?s(t,e):e}}function Gi(i){return e=>Object.assign({},e,i)}function Ki(i){return i}const Ji="http://localhost:3000",Yi="/api",wt="JWT_AUTH_TOKEN",G=class G{constructor(){this.authenticated=!1,this.username="fellow_traveler",this.signOut=()=>{}}static deauthenticate(e){const t=new G;return console.log("Deauthenticating",e,G._theUser),e===G._theUser&&(localStorage.removeItem(wt),G._theUser=t),t}};G._theUser=new G;let k=G;class Ie extends k{constructor(e,t){super();const s=e.split(".")[1].replace(/-/g,"+").replace(/_/g,"/"),a=decodeURIComponent(window.atob(s).split("").map(function(u){return"%"+("00"+u.charCodeAt(0).toString(16)).slice(-2)}).join("")),l=JSON.parse(a);console.log("Token payload",l),this.token=e,this.authenticated=!0,this.username=l.username,this.signOut=t}static authenticate(e,t){return k._theUser=new Ie(e,t),localStorage.setItem(wt,e),k._theUser}static authenticateFromLocalStorage(e){const t=localStorage.getItem(wt);return t?Ie.authenticate(t,e):k._theUser}}class Bt{constructor(e){this._base=Yi,this.json=e}base(e=""){return this._base=e,this}get(e){return fetch(this._url(e),{headers:this._headers(),body:this.json&&JSON.stringify(this.json)})}post(e){return fetch(this._url(e),{method:"POST",headers:this._headers(),body:this.json&&JSON.stringify(this.json)})}put(e){return fetch(this._url(e),{method:"PUT",headers:this._headers(),body:this.json&&JSON.stringify(this.json)})}_headers(){const e=this.json!==void 0,t=k._theUser.authenticated,o={"Content-Type":"application/json"};if(t){const a={Authorization:`Bearer ${k._theUser.token}`};return e?{...o,...a}:a}else return e?{...o}:void 0}_url(e){return`${Ji}${this._base}${e}`}}class nr extends Bt{constructor(e){super(Object.fromEntries(e))}}class Tr extends Bt{constructor(){super(void 0)}}var Qi=Object.defineProperty,Xi=Object.getOwnPropertyDescriptor,Ur=(i,e,t,o)=>{for(var s=o>1?void 0:o?Xi(e,t):e,a=i.length-1,l;a>=0;a--)(l=i[a])&&(s=(o?l(e,t,s):l(s))||s);return o&&s&&Qi(e,t,s),s};const Rr="MTVModel",sr={user:new k},Zi=()=>new Wi,Fr=Gi,Dr=Ki;class Lr extends qi{constructor(e){super(e,sr),this.model=sr}}Ur([Ir({context:Rr}),q()],Lr.prototype,"model",2);class St extends Vi{getFromModel(e){if(this._model)return this._model[e]}}Ur([Or({context:Rr,subscribe:!0}),E({attribute:!1})],St.prototype,"_model",2);const Ct=Zi(),en=Ct.update;Ct.addMessage("ProfileSelected",i=>{const{userid:e}=i;return new Tr().get(`/profiles/${e}`).then(t=>{if(t.status===200)return t.json()}).then(t=>{if(t)return console.log("Profile:",t),t}).then(t=>t?Fr({profile:t}):Dr)});Ct.addMessage("ProfileSaved",i=>{const{userid:e,profile:t}=i;return new Bt(t).put(`/profiles/${e}`).then(o=>{if(o.status===200)return o.json()}).then(o=>{o&&console.log("Profile:",o)}).then(o=>o?Fr({profile:o}):Dr)});var tn=Object.defineProperty,rn=Object.getOwnPropertyDescriptor,Le=(i,e,t,o)=>{for(var s=o>1?void 0:o?rn(e,t):e,a=i.length-1,l;a>=0;a--)(l=i[a])&&(s=(o?l(e,t,s):l(s))||s);return o&&s&&tn(e,t,s),s};let ie=class extends S{constructor(){super(),this.names=[],this.namesOriginalOrder=[],this.listAttributes=[],this.sort_state="unsorted",this.initializedNamesOriginalOrder=!1,this.names=[],this.namesOriginalOrder=[...this.names],this.listAttributes=[]}_onStateChanged(i){const e=i.target;this.initializedNamesOriginalOrder||(this.namesOriginalOrder=[...this.names],this.initializedNamesOriginalOrder=!0),this.sort_state=="unsorted"?this.names.sort((t,o)=>{const s=t[0].toUpperCase(),a=o[0].toUpperCase();return s<a?-1:s>a?1:0}):this.sort_state=="sorted"&&(this.names=[...this.namesOriginalOrder]),this.sort_state=e.filteredState}render(){return x`
  ...
  `;Le([E({type:Array})],ie.prototype,"names",2);Le([E({type:Array})],ie.prototype,"namesOriginalOrder",2);Le([E({type:Array})],ie.prototype,"listAttributes",2);Le([q()],ie.prototype,"sort_state",2);ie=Le([O("sortable-list")],ie);var nn=Object.defineProperty,sn=Object.getOwnPropertyDescriptor,nt=(i,e,t,o)=>{for(var s=o>1?void 0:o?sn(e,t):e,a=i.length-1,l;a>=0;a--)(l=i[a])&&(s=(o?l(e,t,s):l(s))||s);return o&&s&&nn(e,t,s),s};let ge=class extends S{constructor(){super(),this.names=[],this.listAttributes=[],this.sort_state="unsorted",this.names=[],this.listAttributes=[]}render(){return x`
      <section class="friends-list">
        <section class="subsection-header-line">
          <h2>${this.listAttributes[0]}</h2>
          <svg class="icon">
  ...
  `;nt([E({type:Array})],ge.prototype,"names",2);nt([E({type:Array})],ge.prototype,"listAttributes",2);nt([q()],ge.prototype,"sort_state",2);ge=nt([O("general-list")],ge);var on=Object.defineProperty,an=Object.getOwnPropertyDescriptor,It=(i,e,t,o)=>{for(var s=o>1?void 0:o?an(e,t):e,a=i.length-1,l;a>=0;a--)(l=i[a])&&(s=(o?l(e,t,s):l(s))||s);return o&&s&&on(e,t,s),s};let Oe=class extends S{constructor(){super(...arguments),this.artists=[],this.listAttributes=""}render(){return x`
  ...
  `;It([E({type:Array})],Oe.prototype,"artists",2);It([E({type:String})],Oe.prototype,"listAttributes",2);Oe=It([O("favorites-list")],Oe);var cn=Object.defineProperty,ln=Object.getOwnPropertyDescriptor,ye=(i,e,t,o)=>{for(var s=o>1?void 0:o?ln(e,t):e,a=i.length-1,l;a>=0;a--)(l=i[a])&&(s=(o?l(e,t,s):l(s))||s);return o&&s&&cn(e,t,s),s};let Q=class extends S{constructor(){super(...arguments),this.open=!1,this.align="left"}render(){return x`
      <input
        type="checkbox"
        id="is-shown"
    ...
    `}_handleChange(i){const e=i.target;this._toggle(e.checked)}_toggle(i){this.open=i,this._toggleClickAway(i)}_toggleClickAway(i){const e=t=>{t.composedPath().includes(this)?t.stopPropagation():this._toggle(!1)};i?document.addEventListener("click",e):document.removeEventListener("click",e)}};Q.styles=T`
    :host {
  ...
  `;ye([E({reflect:!0,type:Boolean})],Q.prototype,"open",2);ye([E()],Q.prototype,"align",2);ye([E()],Q.prototype,"profileImage",2);ye([E()],Q.prototype,"profileUserID",2);ye([E()],Q.prototype,"profileDescription",2);Q=ye([O("drop-down")],Q);var hn=Object.defineProperty,un=Object.getOwnPropertyDescriptor,kr=(i,e,t,o)=>{for(var s=o>1?void 0:o?un(e,t):e,a=i.length-1,l;a>=0;a--)(l=i[a])&&(s=(o?l(e,t,s):l(s))||s);return o&&s&&hn(e,t,s),s};let Je=class extends S{constructor(){super(...arguments),this.on=!1}render(){return x`<label>
      <slot>light mode</slot>
      <span class="slider">
        <input type="checkbox" @change=${this._handleChange} />
      </span>
    </label>`}_handleChange(i){const e=i.target,t=new Event(i.type,{bubbles:!0,composed:!0});document.body.classList.contains("dark-mode")?(document.body.classList.remove("dark-mode"),document.body.classList.add("light-mode")):(document.body.classList.remove("light-mode"),document.body.classList.add("dark-mode")),this.on=e==null?void 0:e.checked,this.dispatchEvent(t)}};Je.styles=T`
    :host {
      display: block;
  ...
  `;kr([E({reflect:!0,type:Boolean})],Je.prototype,"on",2);Je=kr([O("color-mode-switch")],Je);var pn=Object.defineProperty,dn=Object.getOwnPropertyDescriptor,st=(i,e,t,o)=>{for(var s=o>1?void 0:o?dn(e,t):e,a=i.length-1,l;a>=0;a--)(l=i[a])&&(s=(o?l(e,t,s):l(s))||s);return o&&s&&pn(e,t,s),s};let me=class extends S{constructor(){super(),this.title="",this.description="",this.user_id=0,this.title="",this.description=""}render(){return x`<div class="user-friend">
  ...
  `;st([E()],me.prototype,"title",2);st([E()],me.prototype,"description",2);st([E()],me.prototype,"user_id",2);me=st([O("default-card")],me);var fn=Object.defineProperty,gn=Object.getOwnPropertyDescriptor,Ot=(i,e,t,o)=>{for(var s=o>1?void 0:o?gn(e,t):e,a=i.length-1,l;a>=0;a--)(l=i[a])&&(s=(o?l(e,t,s):l(s))||s);return o&&s&&fn(e,t,s),s};let Te=class extends S{constructor(){super(...arguments),this.on=!1,this.filteredState=""}render(){return x`<label>
      <slot class="label-title">sort alphabetically by name</slot>
      <span class="slider">
        <input type="checkbox" @change=${this._onInput} />
      </span>
    </label>`}_onInput(){this.filteredState=="unsorted"?this.filteredState="sorted":this.filteredState="unsorted",this.dispatchEvent(new Event("state-changed"))}};Te.styles=T`
    :host {
      display: block;
      padding: 0.5em 0.5em 0.5em 0em;
    }
  ...
  `;Ot([E({reflect:!0,type:Boolean})],Te.prototype,"on",2);Ot([E()],Te.prototype,"filteredState",2);Te=Ot([O("toggle-switch")],Te);var mn=Object.defineProperty,_n=Object.getOwnPropertyDescriptor,Tt=(i,e,t,o)=>{for(var s=o>1?void 0:o?_n(e,t):e,a=i.length-1,l;a>=0;a--)(l=i[a])&&(s=(o?l(e,t,s):l(s))||s);return o&&s&&mn(e,t,s),s};let Ue=class extends S{constructor(){super(...arguments),this.path=""}get profile(){return this.using||{}}render(){const{name:i,profileImage:e,profileDescription:t,bio:o}=this.profile;return x`
  ...
  `;ot([q()],_e.prototype,"loginStatus",2);ot([q()],_e.prototype,"registerStatus",2);ot([Ir({context:Xr}),q()],_e.prototype,"user",2);_e=ot([O("auth-required")],_e);var os=Object.defineProperty,as=Object.getOwnPropertyDescriptor,Rt=(i,e,t,o)=>{for(var s=o>1?void 0:o?as(e,t):e,a=i.length-1,l;a>=0;a--)(l=i[a])&&(s=(o?l(e,t,s):l(s))||s);return o&&s&&os(e,t,s),s};let Fe=class extends S{constructor(){super(...arguments),this.user=new k}render(){const{profileImage:i,profileDescription:e,userid:t}=this.profile||{};return x`
...
`,"CLIENTSECRET: ",e);const t=await fetch("https://accounts.spotify.com/api/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded",Authorization:"Basic "+Zr.Buffer.from(`${i}:${e}`).toString("base64")},body:"grant_type=client_credentials"});if(t.ok){const o=await t.json();console.log("Authentication response data: ",o),this.accessToken=o.access_token,console.log("Access Token:",this.accessToken)}else console.error("Spotify authentication failed")}async searchSpotify(){if(!this.requestedSearchQuery.trim())return;const i=`https://api.spotify.com/v1/search?q=${encodeURIComponent(this.requestedSearchQuery)}&type=track&limit=10`;try{await this.authenticate();const e=await fetch(i,{method:"GET",headers:{Authorization:`Bearer ${this.accessToken}`,"Content-Type":"application/json"}});if(!e.ok)throw new Error(`Error: ${e.statusText}`);const t=await e.json();console.log("Tracks Search Response: ",t),t.tracks.items.length>0?(this.topTracks=t.tracks.items,console.log("Tracks found:",this.topTracks)):(this.topTracks=[],alert("No tracks found. Please try another search."))}catch(e){console.error("Error searching for tracks:",e)}}render(){var e,t,o;const i=(e=this.post)!=null&&e.postTime?new Date(this.post.postTime).toLocaleString():"";return x`
  ...
  `;X([E({type:Object})],H.prototype,"post",2);X([q()],H.prototype,"expanded",2);X([E({type:String})],H.prototype,"requestedSearchQuery",2);X([E({type:String})],H.prototype,"accessToken",2);X([E()],H.prototype,"topTracks",2);X([E()],H.prototype,"selectedTracks",2);X([q()],H.prototype,"expandedClass",2);H=X([O("feed-post")],H);var Es=Object.defineProperty,xs=Object.getOwnPropertyDescriptor,ri=(i,e,t,o)=>{for(var s=o>1?void 0:o?xs(e,t):e,a=i.length-1,l;a>=0;a--)(l=i[a])&&(s=(o?l(e,t,s):l(s))||s);return o&&s&&Es(e,t,s),s};let tt=class extends S{constructor(){super(...arguments),this.posts=[]}render(){return x`
      <div class="posts-container">
        ${this.posts.map(i=>x` <feed-post .post=${i}></feed-post>`)}
      </div>
    `}};tt.styles=T``;ri([E({type:Array})],tt.prototype,"posts",2);tt=ri([O("feed-post-list")],tt);var $s=Object.defineProperty,As=Object.getOwnPropertyDescriptor,ii=(i,e,t,o)=>{for(var s=o>1?void 0:o?As(e,t):e,a=i.length-1,l;a>=0;a--)(l=i[a])&&(s=(o?l(e,t,s):l(s))||s);return o&&s&&$s(e,t,s),s};let rt=class extends S{constructor(){super(...arguments),this.posts=[]}async connectedCallback(){super.connectedCallback(),await this._fetchData()}async _fetchData(){console.log("fetching posts!");try{const i=await fetch("http://localhost:3000/posts");if(i.ok){const e=await i.json();this.posts=e,console.log("POSTS RECEIVED: ",this.posts)}else console.error("Failed to fetch posts:",i.status)}catch(i){console.error("Error fetching posts:",i)}}render(){return x`
  ...
  `;ii([E({type:Array})],rt.prototype,"posts",2);rt=ii([O("main-feed")],rt);var Ps=Object.defineProperty,Bs=Object.getOwnPropertyDescriptor,Ss=(i,e,t,o)=>{for(var s=o>1?void 0:o?Bs(e,t):e,a=i.length-1,l;a>=0;a--)(l=i[a])&&(s=(o?l(e,t,s):l(s))||s);return o&&s&&Ps(e,t,s),s};let xt=class extends St{render(){return x`
  ...
  `;xt=Ss([O("home-page")],xt);var Cs=Object.defineProperty,Is=Object.getOwnPropertyDescriptor,Os=(i,e,t,o)=>{for(var s=o>1?void 0:o?Is(e,t):e,a=i.length-1,l;a>=0;a--)(l=i[a])&&(s=(o?l(e,t,s):l(s))||s);return o&&s&&Cs(e,t,s),s};let Ts=[{path:"/app/profile/:userid/:edit(edit)",component:"profile-page"},{path:"/app/profile/:userid",component:"profile-page"},{path:"/app/home",component:"home-page"},{path:"(.*)",component:"not-found-page"}],vr=class extends Lr{constructor(){super(en)}render(){return x`
      <auth-required>
        <match-the-vibe-header></match-the-vibe-header>
        <vaadin-router .routes=${Ts}> </vaadin-router>
      </auth-required>
    `}updated(i){console.log("MTVAPPElement updated:",i.keys()),i.has("model")&&(console.log("New model",this.model),this.requestUpdate())}};vr=Os([O("mtv-app")],vr);
